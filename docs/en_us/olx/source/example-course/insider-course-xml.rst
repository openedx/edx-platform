...
The courseware for edX-Insider is defined in the `course.xml`_ file and follows
the organization described in :ref:`The Courseware Structure`.
...
The edX-Insider courseware is organized into chapters, sequential, and
verticals.
