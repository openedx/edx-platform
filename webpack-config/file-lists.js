...
module.exports = {
    ...
    textBangUnderscore: [
        ...
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/certificate_list_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/certificate_status_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/collection_list_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/course_card_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/course_enroll_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/course_entitlement_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/expired_notification_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/explore_new_programs_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/program_card_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/program_details_sidebar_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/program_details_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/program_header_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/sidebar_view.js'),
        path.resolve(__dirname, '../lms/static/js/programs_dashboard/views/upgrade_message_view.js'),
