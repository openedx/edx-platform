...
@deprecated('invoke tests.test_system')
...
@deprecated('invoke tests.test_lib')
...
@deprecated('invoke tests.test_python')
...
@deprecated('invoke tests.test_i18n')
def test_i18n():
    """
    Run all i18n tests
    """
...
@deprecated('invoke tests.coverage')
