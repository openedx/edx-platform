...
from xmodule.pool_block import PoolBlock
...
class LibraryContentBlock(  # @@TODO: Rename to something like LegacyLibraryPoolBlock?
    PoolBlock,
    ...
    def format_block_keys_for_analytics(self, block_keys: list[tuple[str, str]]) -> dict:
        """
        Given a list of (block_type, block_id) pairs,
