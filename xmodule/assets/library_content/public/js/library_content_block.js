window.LibraryContentBlockPickerView = function(runtime, element) {
    'use strict';
    var self = this;

    $('#library-content-block-picker', element).on('selected-xblocks', function(e, params) {
        self.sourceBlockIds = params.sourceBlockIds;
    });

    $('#library-content-block-picker', element).on('error', function(e, params) {
