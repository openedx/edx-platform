...
class SignalHandler:
    ...
    course_cache_updated = SwitchedSignal("course_cache_updated")
    ...
    _mapping = {
        signal.name: signal
        for signal
        in [pre_publish, course_published, course_deleted, course_cache_updated, library_updated, item_deleted]
    }
