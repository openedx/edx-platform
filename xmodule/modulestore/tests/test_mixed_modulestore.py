...
class TestMixedModuleStore(CommonMixedModuleStoreSetup):
    ...
    def test_create_item_populates_edited_info(self, default_ms):
        ...
        assert datetime.datetime.now(get_utc_timezone()) > block.edited_on
    ...
    def test_create_item_populates_subtree_edited_info(self, default_ms):
        ...
        assert datetime.datetime.now(get_utc_timezone()) > block.subtree_edited_on
    ...
    def test_update_edit_info_ancestors(self, default_ms):
        ...
        after_create = datetime.datetime.now(get_utc_timezone())
        ...
        after_edit = datetime.datetime.now(get_utc_timezone())
    ...
    def test_update_published_info(self, default_ms):
        ...
        old_time = datetime.datetime.now(get_utc_timezone())
