...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Search_SearchContainer__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Search/SearchContainer.jsx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Table_EntitlementSupportTableContainer__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/Table/EntitlementSupportTableContainer.jsx");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__EntitlementForm_container__ = __webpack_require__("./lms/djangoapps/support/static/support/jsx/entitlements/components/EntitlementForm/container.jsx");
...
var Main = function Main(props) {
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["StatusAlert"], {
      alertType: 'danger',
...
var MainContent = function MainContent(props) {
  if (props.isFormOpen) {
    return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_6__EntitlementForm_container__["a" /* default */], null);
  }
  ...
  return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
    ...
    __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
      'div',
      { className: 'actions' },
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_4__Search_SearchContainer__["a" /* default */], null),
      __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_3__edx_paragon__["Button"], {
        className: ['btn', 'btn-primary'],
        label: 'Create New Entitlement',
        onClick: props.openCreationForm
      })
    ),
    props.entitlements.length > 0 ? __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_5__Table_EntitlementSupportTableContainer__["a" /* default */], { ecommerceUrl: props.ecommerceUrl }) : null
  );
};
...
Main.propTypes = {
  ...
  entitlements: __WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.arrayOf(__WEBPACK_IMPORTED_MODULE_1_prop_types___default.a.string).isRequired
};
...
/* harmony default export */ __webpack_exports__["a"] = (__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_2_react_redux__["b" /* connect */])(mapStateToProps, null)(Main));
    ...
    value: function render() {
      return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
        ...
        __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__edx_paragon__["InputText"], {
          ...
          onChange: this.handleUsernameChange,
          inputGroupAppend: __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__edx_paragon__["Button"], { className: ['btn', 'btn-primary', 'ml-2', 'search-button'], label: 'Search', type: 'submit' })
        })
      );
    }
  }]);
...
var emptyEntitlementsFailure = function emptyEntitlementsFailure(error) {
  return function (dispatch) {
    return dispatch(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_3__error__["b" /* displayError */])('No Entitlements Found', error));
  };
};
  ...
  return function (dispatch) {
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__api_client__["a" /* getEntitlements */])(username).then(function (response) {
      ...
      if (json.count === 0) {
        ...
        dispatch(fetchEntitlementsSuccess(__WEBPACK_IMPORTED_MODULE_0_camelize___default()(json.results)));
      }
    }, function (error) {
