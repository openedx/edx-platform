(function(e, a) { for(var i in a) e[i] = a[i]; }(window, webpackJsonp([5,6,12],{
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DemographicsCollectionBanner", function() { return DemographicsCollectionBanner; });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__DemographicsCollectionModal__ = __webpack_require__("./lms/static/js/demographics_collection/DemographicsCollectionModal.jsx");
...
var DemographicsCollectionBanner = function (_React$Component) {
  _inherits(DemographicsCollectionBanner, _React$Component);

  function DemographicsCollectionBanner(props) {
    _classCallCheck(this, DemographicsCollectionBanner);

    var _this = _possibleConstructorReturn(this, (DemographicsCollectionBanner.__proto__ || Object.getPrototypeOf(DemographicsCollectionBanner)).call(this, props));
  ...
  _createClass(DemographicsCollectionBanner, [{
    key: 'dismissBanner',
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return fetch(this.props.lmsRootUrl + '/api/demographics/v1/demographics/status/', requestOptions);
      ...
      if (!this.state.hideBanner) {
        return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
          ...
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'a',
            { id: 'demographics-banner-link', className: 'btn', onClick: function onClick() {
            ...
            __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
              ...
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'd-flex justify-content-left align-items-lg-center flex-column flex-lg-row  w-100' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('img', { className: 'demographics-banner-icon d-none d-lg-inline-block', src: this.props.bannerLogo, alt: '', 'aria-hidden': 'true' }),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  'div',
                  { className: 'demographics-banner-prompt d-inline-block font-weight-bold text-white mr-4 py-3 px-2 px-lg-3' },
                  gettext('Want to make edX better for everyone?')
                ),
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  'button',
                  { className: 'demographics-banner-btn d-flex align-items-center bg-white font-weight-bold border-0 py-2 px-3 mx-2 mb-3 m-lg-0 shadow justify-content-center' },
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('span', { className: 'fa fa-thumbs-up px-2', 'aria-hidden': 'true' }),
                  gettext('Get started')
                )
              ),
              __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                'div',
                { className: 'demographics-dismiss-container md-flex justify-content-right align-self-start align-self-lg-center  ml-lg-auto' },
                __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
                  'button',
                  { type: 'button', className: 'demographics-dismiss-btn btn btn-default px-0', id: 'demographics-dismiss', 'aria-label': 'close' },
                  __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement('i', { className: 'fa fa-times-circle text-white px-2', 'aria-hidden': 'true', onClick: this.dismissBanner })
                )
              )
            )
          ),
          __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(
            'div',
            null,
            this.state.modalOpen && __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__DemographicsCollectionModal__["DemographicsCollectionModal"], _extends({}, this.props, {
  ...
  return DemographicsCollectionBanner;
...
//# sourceMappingURL=DemographicsCollectionBanner.js.map