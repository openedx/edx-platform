...
class OptionInputTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        option_input = lookup_tag('optioninput')(get_capa_system(), element, state)
...
class ChoiceGroupTest(unittest.TestCase):
  ...
  <{tag}>
    ...
    <choice correct="false" name="foil4">This is <b>foil</b> Four.</choice>
        ...
        the_input = lookup_tag(tag)(get_capa_system(), element, state)
...
class JSInputTest(unittest.TestCase):
    ...
    def _render_context_test(self, xml_str, expected_context):
        ...
        the_input = lookup_tag('jsinput')(get_capa_system(), element, state)
...
class TextLineTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        the_input = lookup_tag('textline')(get_capa_system(), element, state)
...
class FileSubmissionTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        the_input = input_class(get_capa_system(), element, state)
...
class MatlabTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.the_input = self.input_class(get_capa_system(), elt, state)
    ...
    def test_rendering_with_state(self):
        ...
        the_input = self.input_class(get_capa_system(), elt, state)
        context = the_input._get_render_context()  # pylint: disable=protected-access
        prob_id = 'prob_1_2'
        expected = {
            'STATIC_URL': '/dummy-static/',
...
class SchematicTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        the_input = lookup_tag('schematic')(get_capa_system(), element, state)
...
class ImageInputTest(unittest.TestCase):
    ...
    def check(self, value, egx, egy):  # lint-amnesty, pylint: disable=missing-function-docstring
        ...
        the_input = lookup_tag('imageinput')(get_capa_system(), element, state)
...
class CrystallographyTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        the_input = lookup_tag('crystallography')(get_capa_system(), element, state)
...
class VseprTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        the_input = lookup_tag('vsepr_input')(get_capa_system(), element, state)
...
class ChemicalEquationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.the_input = lookup_tag('chemicalequationinput')(get_capa_system(), element, state)
...
class FormulaEquationTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.the_input = lookup_tag('formulaequationinput')(get_capa_system(), element, state)
    ...
    def test_trailing_text_rendering(self):
        ...
        for xml_text, expected_text in trailing_text:
            ...
            the_input = lookup_tag('formulaequationinput')(get_capa_system(), element, state)
...
class DragAndDropTest(unittest.TestCase):
    ...
    def test_rendering(self):
        ...
        the_input = lookup_tag('drag_and_drop_input')(get_capa_system(), element, state)
        prob_id = 'prob_1_2'
        context = the_input._get_render_context()  # pylint: disable=protected-access
        expected = {
            'STATIC_URL': '/dummy-static/',
