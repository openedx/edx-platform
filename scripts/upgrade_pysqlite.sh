...
curl -o sqlite-autoconf-3280000.tar.gz https://www.sqlite.org/2019/sqlite-autoconf-3280000.tar.gz
tar -xzvf sqlite-autoconf-3280000.tar.gz
tar -xzvf 2.8.3.tar.gz
cp -av sqlite-autoconf-3280000/. pysqlite-2.8.3/
