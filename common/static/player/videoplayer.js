...
mejs.MediaElementDefaults = {
    ...
    type: "",
    pluginPath: mejs.Utility.getScriptPath(["videoplayer.css", "videoplayer.js"]),
    flashName: "flashplayer.swf",
    flashStreamer: "",
...
mejs.HtmlMediaElementShim = {
    create: function(a, b) {
        ...
        if (k.url.indexOf(".") == -1 && k.url.length == 32) {
            k.method = "";
        } else {
...
determinePlayback: function(a, b, c, d, e) {
        ...
        if (typeof b.type != "undefined" && b.type !== "") if (typeof b.type == "string") f.push({
            ...
            if (h.nodeType == 1 && h.tagName.toLowerCase() == "source") {
                ...
                if (e.indexOf(".") == -1 && e.length == 32) {
                    $.ajax({
                        type: "GET",
                        async: false,
                        url: '/videoid2source/' + e,
                        success: function(data) {
                            if (typeof data['sources']['quality10'][0] !== 'undefined') {
                                e = data['sources']['quality10'][0];
								sources['s10'] = e;
                            }
							if(typeof data['sources']['quality20'][0] !== 'undefined'){
								sources['s20'] =  data['sources']['quality20'][0];
							}
                        }
                    });
                }
    ...
    createErrorMessage: function(a, b, c) {
        ...
        e.innerHTML = b.customError ? b.customError: (a.url.indexOf(".") == -1 && a.url.length == 32) ? '<img src="/static/player/encoding.jpg" width="100%" height="100%" />': c !== "" ? '<a href="' + a.url + '"><img src="' + c + '" width="100%" height="100%" /></a>': '<a href="' + a.url + '"><span>' + mejs.i18n.t("下载该视频") + "</span></a>";
    ...
    createPlugin: function(a, b, c, d, e, f) {
        ...
        case "flash":
            if (mejs.MediaFeatures.isIE) {
                ...
                k.appendChild(a);
                a.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="//download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab" id="' + l + '" width="' + g + '" height="' + h + '" class="mejs-shim"><param name="movie" value="/static/player/' + b.flashName + "?x=" + new Date + '" /><param name="flashvars" value="' + d.join("&amp;") + '" /><param name="quality" value="high" /><param name="bgcolor" value="#000000" /><param name="wmode" value="transparent" /><param name="allowScriptAccess" value="always" /><param name="allowFullScreen" value="true" /></object>'
            } else k.innerHTML = 
            '<embed id="' + l + '" name="' + l + '" play="true" loop="false" quality="high" bgcolor="#000000" wmode="transparent" allowScriptAccess="always" allowFullScreen="true" type="application/x-shockwave-flash" pluginspage="//www.macromedia.com/go/getflashplayer" src="/static/player/' + b.flashName + '" flashvars="' + d.join("&") + '" width="' + g + '" height="' + h + '" class="mejs-shim"></embed>';
            break;
        case "youtube":
...
clickToPlayPause: true,
        ...
        features: ["playpause", "current", "progress", "duration", "tracks", "rate", "quality" , "volume", "fullscreen", "rightsubtitles"],
        isVideo: true,
        enableKeyboard: true,
    ...
    mejs.MediaElementPlayer.prototype = {
        ...
        showControls: function(a) {
            ...
            if (!b.controlsAreVisible) {
                if (a) {
                    ...
                    "visible").stop(true, true).fadeIn(200, 
                    function() {
                        b.controlsAreVisible = true
                    })
                } else {
        ...
        hideControls: function(a) {
			...
			b.container.find('.mejs-captions-selector').css('visibility','hidden');
            b.container.find('.mejs-volume-slider').css('display', 'none');
			b.container.find('.mejs-rate-selector').css('visibility' ,'hidden');
			b.container.find('.mejs-quality-selector').css('visibility' ,'hidden');
        },
        controlsTimer: null,
        ...
        meReady: function(a, b) {
            ...
            d = !(typeof d == "undefined" || d === null || d === "false") || ($.cookie('seekTo') !== null);
            var g;
            if (!c.created) {
                c.created = true;
                c.media = a;
                ...
                if (! (e.isAndroid && c.options.AndroidUseNativeControls) && !(e.isiPad && c.options.iPadUseNativeControls) && !(e.isiPhone && c.options.iPhoneUseNativeControls)) {
                    ...
                    function() {
                        ...
                        if ($.cookie("seekTo") !== null) {
                            c.media.setCurrentTime(parseInt($.cookie("seekTo")));
                            $.cookie("seekTo", null, {
                                path: '/'
                            });
                        }
...
c = b.find("img");
        ...
        buildoverlays: function(a, b, c, e) {
            ...
            if (a.isVideo) {
				...
				c.find('.mejs-overlay-button').hover(
					function(){
						f(this).css('opacity' ,1.0)
					} ,function(){
						f(this).css('opacity' ,0.3)
					}
				);
                e.addEventListener("play", 
                function() {
...
setVolume: function(a) {
 ...
 (function(f) {
    f.extend(mejs.MepDefaults, {
        playpauseText: mejs.i18n.t("播放/暂停")
    });
        ...
        buildprogress: function(a, b, c, e) {
            ...
            function(h) {
                if (h.which === 1) {
                    t = true;
                    p(h);
                    d.globalBind("mousemove.dur", 
                    function(l) {
                        p(l)
                    });
                    d.globalBind("mouseup.dur", 
                    function() {
                        t = false;
                        m.hide();
                        d.globalUnbind(".dur")
...
j = d.container.find(".mejs-volume-slider, .mejs-horizontal-volume-slider"),
                ...
                function(n) {
                    h(n);
                    d.globalBind("mousemove.vol", 
                    function(o) {
                        h(o)
                    });
                    d.globalBind("mouseup.vol", 
                    function() {
                        l = false;
        ...
        buildfullscreen: function(a, b, c, e) {
            if (a.isVideo) {
                ...
                if (d.media.pluginType === "native" || !d.options.usePluginFullScreen && !mejs.MediaFeatures.isFirefox) g.click(function() {
                    ...
                    mejs.MediaFeatures.isFullScreen() || a.isFullScreen ? function(){
						a.exitFullScreen();
						if(d.controls.find('input[type=checkbox][value=right]:checked').html() != null){
							d.container.find('.mejs-subtitles').show();
						}
...
containerSizeTimeout: null,
 ...
 (function(f) {
    f.extend(mejs.MepDefaults, {
        startLanguage: "",
        tracksText: mejs.i18n.t("字幕"),
        hideCaptionsButtonWhenEmpty: true,
        toggleCaptionsButtonWhenOnlyOne: false,
        displayCaptionWhenOnlyOne: false,
        slidesSelector: ""
    });
    f.extend(MediaElementPlayer.prototype, {
        hasChapters: false,
        buildtracks: function(a, b, c, e) {
            if (a.tracks.length != 0) {
				...
				var buttonHTML = '<div class="mejs-button mejs-captions-button"><button type="button" aria-controls="' + this.id + '" title="' + this.options.tracksText + '" aria-label="' + this.options.tracksText + '"></button><div class="mejs-captions-selector"><ul><li><input type="checkbox" name="' + a.id + '_captions" id="' + a.id + '_captions_bottom" value="bottom" checked="checked" /><label for="' + a.id + '_captions_bottom">' + mejs.i18n.t("下方字幕") + "</label></li>" + '<li><input type="checkbox" name="' + a.id + '_captions" id="' + a.id + '_captions_right" value="right" checked="checked" /><label for="' + a.id + '_captions_right">' + mejs.i18n.t("右侧字幕") + "</label></li><hr></hr>" + "</ul></div></div>"
				a.captionsButton = f(buttonHTML).appendTo(b);
				a.captionsButton.find('input[value=bottom]').click(function(){
					if($(this).attr('checked') == 'checked'){
						a.container.find('.mejs-captions-position').show();	
						a.captionsButton.find('.mejs-captions-selector input[type=radio]').attr('disabled',false);
					}else{
						a.container.find('.mejs-captions-position').hide();
						if(a.captionsButton.find('.mejs-captions-selector input[value=right]').attr('checked') != 'checked'){
							a.captionsButton.find('.mejs-captions-selector input[type=radio]').attr('disabled' ,true);
						}
					}
				});
				a.captionsButton.find('input[value=right]').click(function(){
					if($(this).attr('checked') == 'checked'){
						a.container.find('.mejs-subtitles').show();
						a.captionsButton.find('.mejs-captions-selector input[type=radio]').attr('disabled',false);
					}else{
						a.container.find('.mejs-subtitles').hide();
						if(a.captionsButton.find('.mejs-captions-selector input[value=bottom]').attr('checked') != 'checked'){
							a.captionsButton.find('.mejs-captions-selector input[type=radio]').attr('disabled',true);
						}
					}
				});
				lang=getCookie('lang');
                if(lang!=null && lang!=''){
					this.options.startLanguage=lang;
				}
				for (b =  c = 0; b < a.tracks.length; b++) {
					a.tracks[b].kind == "subtitles" && c++;
				}
                if (this.options.displayCaptionWhenOnlyOne && c == 1) {
                    this.options.startLanguage = a.tracks[0].srclang;
                }
                this.options.toggleCaptionsButtonWhenOnlyOne && c == 1 ? a.captionsButton.on("click", 
                function() {
                ...
                function() {
                    lang = this.value;
                    a.setTrack(lang);
					a.captionsButton.find('.mejs-captions-selected').removeClass('mejs-captions-selected');
					f(this).next().addClass('mejs-captions-selected');
                });
                a.options.alwaysShowControls?a.container.find(".mejs-captions-position").addClass("mejs-captions-position-hover") : a.container.bind("controlsshown", 
                function() {
                ...
                function() {
                    a.hasChapters && 
                    !e.paused && a.chapters.fadeOut(200, 
                    function() {
                        f(this).css("visibility", "hidden");
                        f(this).css("display", "block")
                    })
                });
				a.captionsButton.find('.radio').hover(function(){
	               f(this).css('background-color','linear-gradient(rgba(44,124,145,0.8), rgba(78,183,212,0.8))');
                } ,function(){
                   f(this).css('background-color','rgba(50,50,50,0)');
                });
                a.node.getAttribute("autoplay") !== null && a.chapters.css("visibility", "hidden")
            }
        },
        setTrack: function(a) {
			setCookie('lang',a,365);	
            var b;
            if (a == "none") {
        ...
        loadTrack: function(a) {
            ...
            f.ajax({
                ...
                success: function(e) {
                    ...
                    b.loadNextTrack();
                    c.kind == "chapters" && b.media.addEventListener("play", 
                    function() {
...
addTrackButton: function(a, b) {
            if (b === "") b = mejs.language.codes[a] || a;
			s = '<li class="radio"><input type="radio" name="' + this.id + '_captions" id="' + this.id + "_captions_" + a + '"';
			if(a == this.options.startLanguage){
				s+= ' class=".mejs-captions-selected" ';
			}
			s += ' value="' + a + '" disabled="disabled" /><label for="' + this.id + "_captions_" + a + '">' + b + " (loading)</label></li>";
            this.captionsButton.find("ul").append(f(s));
            this.adjustLanguageBox();
...
stop: mejs.Utility.convertSMPTEtoSeconds(e[3]),
                        ...
                        c.start.push(parseInt(mejs.Utility.convertSMPTEtoSeconds(e[1]) * 1000))
                    }
                }
                return c
            }
        ...
        dfxp: {
            parse: function(a) {
                ...
                for (b = 0; b < c.length; b++) {
                    ...
                    if (g) d.style = g;
                    a.start.push(parseInt(d.start * 1000));
 ...
 (function($) {
    $.extend(mejs.MepDefaults, {
        rightSubtitlesText: mejs.i18n.t('右侧字幕')
    });
    $.extend(MediaElementPlayer.prototype, {
        buildrightsubtitles: function(player, controls, layers, media) {
            player.videoCaptionloaded = false;
            player.videoCaptionsubtitlesEl = $('<div class="mejs-subtitles"></div>');
            player.container.find('.mejs-inner').after(player.videoCaptionsubtitlesEl);
            media.addEventListener('timeupdate', 
            function(e) {
                var newIndex;
                if (player.videoCaptionloaded) {
                    var time = Math.round(Time.convert(media.currentTime, '1.0', '1.0') * 1000 + 100);
                    newIndex = player.search(time);
                    if (typeof newIndex !== 'undefined' && player.videoCaptioncurrentIndex !== newIndex) {
                        if (typeof player.videoCaptioncurrentIndex !== 'undefined') {
                            player.videoCaptionsubtitlesEl.find('li.current').removeClass('current')
                        };
                        player.videoCaptionsubtitlesEl.find("li[data-index='" + newIndex + "']").addClass('current');
                        player.videoCaptioncurrentIndex = newIndex;
                        player.scrollCaption()
                    }
                }
            },
            false)
        },
        setRightSubtitle: function(player) {
            player.videoCaptioncurrentIndex = -1;
            if (player.selectedTrack != null) {
                player.videoCaptioncaptions = player.selectedTrack.entries.text;
                player.videoCaptionstart = player.selectedTrack.entries.start;
                player.videoCaptionloaded = true;
                var contain = $('<div>');
                $.each(player.videoCaptioncaptions, 
                function(index, text) {
                    var liEl = $('<li>');
                    liEl.html(text);
                    liEl.attr({
                        'data-index': index,
                        'data-start': player.videoCaptionstart[index]
                    });
                    contain.append(liEl)
                });
                player.videoCaptionsubtitlesEl.html(contain.html());
                player.videoCaptionsubtitlesEl.find('li[data-index]').on('click', 
                function(event) {
                    var time;
                    event.preventDefault();
                    time = Math.round(Time.convert($(event.target).data('start'), '1.0', '1.0') / 1000);
                    player.media.setCurrentTime(time);
                    player.media.play()
                });
                player.videoCaptionsubtitlesEl.prepend($('<li class="spacing">').height(player.topSpacingHeight()));
                player.videoCaptionsubtitlesEl.append($('<li class="spacing">').height(player.bottomSpacingHeight()))
            } else {
                player.videoCaptionsubtitlesEl.html("")
            }
        },
        scrollCaption: function() {
            var el = this.videoCaptionsubtitlesEl.find('.current:first');
            if (el.length) {
                this.videoCaptionsubtitlesEl.scrollTo(el, {
                    offset: -this.calculateOffset(el)
                })
            }
        },
        search: function(time) {
            ...
            max,
            min;
            if (this.videoCaptionloaded) {
                min = 0;
                max = this.videoCaptionstart.length - 1;
                if (time < this.videoCaptionstart[min]) return - 1;
                while (min < max) {
                    index = Math.ceil((max + min) / 2);
                    if (time < this.videoCaptionstart[index]) {
                        max = index - 1
                    };
                    if (time >= this.videoCaptionstart[index]) {
                        min = index
        ...
        topSpacingHeight: function() {
            return this.calculateOffset(this.videoCaptionsubtitlesEl.find('li:not(.spacing):first'))
        },
        bottomSpacingHeight: function() {
            return this.calculateOffset(this.videoCaptionsubtitlesEl.find('li:not(.spacing):last'))
        }
    })
})(mejs.$);
...
(function(f){
	f.extend(mejs.MepDefaults,{
		...
		css:{'1.5':'mejs-rate150' ,'1.25':'mejs-rate125' ,'1':'mejs-rate100' ,'0.75':'mejs-rate075'},
		defaultRate:1.0
	});
	f.extend(MediaElementPlayer.prototype, {
		buildrate:function(player,controls ,layers,media){
			if(this.media.pluginType == 'native'){
				var s = '<div class="mejs-button mejs-rate-button mejs-rate100"><button type="button"></button><div class="mejs-rate-selector"><ul>';
				var i = 0;
				for(i = 0 ; i < this.options.rates.length ; i++){
					var r = this.options.rates[i];
					s += '<li><input type="radio" name="rate" value="' + r + '" id="' + r + '" ';
			    	if(this.options.rates[i] == this.options.defaultRate){
				   		s += 'checked=true ';
						s += '/><label for="' + r + '" class="mejs-rate-selected">'+ this.options.rates[i] + '倍速</label></li>';
					}else{
						s += '/><label for="' + r + '">'+ this.options.rates[i] + '倍速</label></li>';
					}
				}
				s += '</ul></div></div>';
				var t = this;
				player.rateButton = f(s).appendTo(controls);
				player.rateButton.hover(function(e){
					player.killControlsTimer();
					f(this).find(".mejs-rate-selector").css("visibility", "visible");
					e.stopPropagation();
				},function(){
					f(this).find(".mejs-rate-selector").css("visibility", "hidden");
				}).on("click", "input[type=radio]" ,function(){
					var p = media;
					var now = t.options.css[p.playbackRate.toString()];
					p.playbackRate = $(this).attr('value');
					player.rateButton.removeClass(now).addClass(t.options.css[$(this).attr('value')]);
					player.rateButton.find('.mejs-rate-selected').removeClass('mejs-rate-selected');
					player.rateButton.find('input[type=radio]:checked').next().addClass('mejs-rate-selected');
				});
				player.rateButton.find('li').hover(function(){
					f(this).css('background-color','linear-gradient(rgba(44,124,145,0.8), rgba(78,183,212,0.8))');	
				} ,function(){	
					f(this).css('background-color','rgba(50,50,50,0)');
				});
				player.rateButton.find(".mejs-rate-selector").height(this.rateButton.find(".mejs-rate-selector ul").outerHeight(true) + player.rateButton.find(".mejs-rate-translations").outerHeight(true));
			}
		}
	});
})(mejs.$);
...
(function(f){
	...
	f.extend(MediaElementPlayer.prototype ,{
		buildquality:function(player ,controls ,layers ,media){
			if(this.media.pluginType=='native'  && sources['s10']!='' && sources['s20']!=''){
				var s = '<div class="mejs-button mejs-quality-button mejs-quality10"><button type="button"></button><div class="mejs-quality-selector"><ul>';
				s+= '<li><input type="radio" name="quality" id="q10" value="10" ><label for="q10" class="mejs-quality-selected">流畅</label></li>';
				s+= '<li><input type="radio" name="quality" id="q20" value="20" ><label for="q20">清晰</label></li>';
				s+= '</ul></div></div>';
				var t = this;
				player.qualityButton = f(s).appendTo(controls);
				player.qualityButton.hover(function(){
					f(this).find(".mejs-quality-selector").css("visibility", "visible");
				},function(){
					f(this).find(".mejs-quality-selector").css("visibility", "hidden");
				}).on('click' ,'input[type=radio]' ,function(e){
					var p = media;
                    if($(this).attr('value') != t.options.nowquality ){
						temt = p.currentTime;
						flag = true;
						t.options.nowquality = $(this).attr('value');
						t.setSrc(sources['s'+$(this).attr('value')]);
						if(t.options.nowquality == '10'){
							player.qualityButton.removeClass("mejs-quality20").addClass("mejs-quality10");
						}else{
							player.qualityButton.removeClass("mejs-quality10").addClass("mejs-quality20");
						}
						player.qualityButton.find('.mejs-quality-selected').removeClass('mejs-quality-selected');
						player.qualityButton.find('input[type=radio]:checked').next().addClass('mejs-quality-selected');
					}
					e.preventDefault();
					e.stopPropagation();
				});
				player.qualityButton.find('li').hover(function(){
	                f(this).css('background-color','linear-gradient(rgba(44,124,145,0.8), rgba(78,183,212,0.8))');
	            } ,function(){
	                f(this).css('background-color','rgba(50,50,50,0)');
	            });
				player.qualityButton.find(".mejs-quality-selector").height(this.qualityButton.find(".mejs-quality-selector ul").outerHeight(true) + player.qualityButton.find(".mejs-quality-translations").outerHeight(true));
				console.log(getCookie('quality'));
				if(getCookie('quality') == '20'){
					player.qualityButton.find('#q20').attr('checked',true).click();
					flag = false;
				}else{
					player.qualityButton.find('#q10').attr('checked',true);
				}
				media.addEventListener('canplay' ,function(){
					if(flag){
						flag = false;
						media.setCurrentTime(temt);
						media.pause();
						media.play();
					}
				} ,false);
				media.addEventListener('play',function(){
					player.rateButton.find('.mejs-rate-selector input[name=rate]:checked').trigger('click');
				},false);
				$(window).bind('beforeunload',function(e){
				    setCookie('quality',t.options.nowquality ,365);
				})
			}else{
				//alert(sources['s10']);
				//alert(sources['s20']);
