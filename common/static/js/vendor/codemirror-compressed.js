...
CodeMirror.defineMode("css", function (config, parserConfig) {
  ...
  var indentUnit = config.indentUnit, tokenHooks = parserConfig.tokenHooks, mediaTypes = parserConfig.mediaTypes || {},
    mediaFeatures = parserConfig.mediaFeatures || {}, propertyKeywords = parserConfig.propertyKeywords || {},
...
CodeMirror.defineMode("diff", function () {
  var TOKEN_NAMES = {"+": "positive", "-": "negative", "@": "meta"};
  return {
    token: function (stream) {
...
CodeMirror.defineMode("edx_markdown", function (cmCfg, modeCfg) {
  ...
  var header = "header", code = "comment", quote = "quote", list = "string", hr = "hr", linktext = "link",
    linkhref = "string", em = "em", strong = "strong", emstrong = "emstrong";
  var hrRE = /^([*\-=_])(?:\s*\1){2,}\s*$/, ulRE = /^[*\-+]\s+/, olRE = /^[0-9]+\.\s+/, headerRE = /^(?:\={3,}|-{3,})$/,
    textRE = /^[^\[*_\\<>`]+/;
...
(function () {
  CodeMirror.extendMode("css", {
    commentStart: "/*", commentEnd: "*/", newlineAfterToken: function (_type, content) {
      return /^[;{}]$/.test(content)
    }
  });
