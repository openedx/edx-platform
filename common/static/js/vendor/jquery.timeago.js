  ...
  $.extend($.timeago, {
    settings: {
      ...
      strings: {
        ...
        minutes: ngettext("%d minute", "%d minutes"),
        hour: gettext("about an hour"),
        hours: ngettext("about %d hour", "about %d hours"),
        day: gettext("a day"),
        days: ngettext("%d day", "%d days"),
        month: gettext("about a month"),
        months: ngettext("%d month", "%d months"),
        year: gettext("about a year"),
        years: ngettext("%d year", "%d years"),
        numbers: []
      }
    },
