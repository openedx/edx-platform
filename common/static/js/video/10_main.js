...
/* End RequireJS */
    ...
    /* End Webpack */
        [
            'js/video/00_video_storage.js',
            'js/video/01_initialize.js',
            'js/video/025_focus_grabber.js',
            'js/video/035_video_accessible_menu.js',
            'js/video/04_video_control.js',
            'js/video/04_video_full_screen.js',
            'js/video/05_video_quality_control.js',
            'js/video/06_video_progress_slider.js',
            'js/video/07_video_volume_control.js',
            'js/video/08_video_speed_control.js',
            'js/video/08_video_auto_advance_control.js',
            'js/video/09_video_caption.js',
            'js/video/09_play_placeholder.js',
            'js/video/09_play_pause_control.js',
            'js/video/09_play_skip_control.js',
            'js/video/09_skip_control.js',
            'js/video/09_bumper.js',
            'js/video/09_save_state_plugin.js',
            'js/video/09_events_plugin.js',
            'js/video/09_events_bumper_plugin.js',
            'js/video/09_poster.js',
            'js/video/09_completion.js',
            'js/video/10_commands.js',
            'js/video/095_video_context_menu.js'
        ],
        function(
