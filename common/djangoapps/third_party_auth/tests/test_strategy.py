...
class TestStrategy(TestCase):
    ...
    @ddt.unpack
    def test_request_host(self, respect_x_headers, x_forwarded_value, get_host_value, expected_value):
        self.request_mock.META = {}
        self.request_mock.get_host.return_value = get_host_value
    ...
    @ddt.unpack
    def test_request_port(self, respect_x_headers, x_forwarded_value, server_port_value, expected_value):
