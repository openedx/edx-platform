...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            u"\nDone."
            "\n{total} provider(s) found in database."  # pylint: disable=unicode-format-string
            "\n{skipped} skipped and {attempted} attempted."  # pylint: disable=unicode-format-string
            "\n{updated} updated and {failed} failed.\n".format(  # pylint: disable=unicode-format-string
                total=total,
