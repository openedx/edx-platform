...
class TestRemoveSocialAuthUsersCommand(TestCase):
    ...
    def setUp(self):
        super().setUp()
        self.provider_hogwarts = SAMLProviderConfigFactory.create(slug='hogwarts', entity_id='hogwarts')
        self.provider_durmstrang = SAMLProviderConfigFactory.create(slug='durmstrang', entity_id='durmstrang')
