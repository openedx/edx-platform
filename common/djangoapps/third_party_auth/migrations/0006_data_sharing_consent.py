    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('new_state', models.CharField(default=b'disabled', help_text='The state of the linked UserDataSharingConsentAudit after the state transition indicated by this recordd.', max_length=8, choices=[(b'not_set', b'Not set'), (b'enabled', b'Enabled'), (b'disabled', b'Disabled')])),
