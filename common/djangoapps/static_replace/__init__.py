...
def replace_static_urls(text, data_directory, course_id=None, static_asset_path='', replacement_function=None):
    """
    ...
    def wrap_part_extraction(processing_function):
        ...
        def extractor(match):
            ...
            quote = match.group('quote')
            rest = match.group('rest')
            return processing_function(original, prefix, quote, rest)
    ...
    return re.sub(
        ...
        wrap_part_extraction(replacement_function or replace_static_url),
        text
    )
