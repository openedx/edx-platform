...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'MicrositeTemplate'
        db.create_table('microsite_configuration_micrositetemplate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('microsite', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['microsite_configuration.Microsite'])),
            ('template_uri', self.gf('django.db.models.fields.CharField')(max_length=255, db_index=True)),
            ('template', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('microsite_configuration', ['MicrositeTemplate'])

        # Adding unique constraint on 'MicrositeTemplate', fields ['microsite', 'template_uri']
        db.create_unique('microsite_configuration_micrositetemplate', ['microsite_id', 'template_uri'])

        # Adding model 'HistoricalMicrositeTemplate'
        db.create_table('microsite_configuration_historicalmicrositetemplate', (
        ...
        db.send_create_signal('microsite_configuration', ['HistoricalMicrositeTemplate'])


    def backwards(self, orm):
        # Removing unique constraint on 'MicrositeTemplate', fields ['microsite', 'template_uri']
        db.delete_unique('microsite_configuration_micrositetemplate', ['microsite_id', 'template_uri'])

        # Deleting model 'MicrositeTemplate'
        db.delete_table('microsite_configuration_micrositetemplate')

        # Deleting model 'HistoricalMicrositeTemplate'
        db.delete_table('microsite_configuration_historicalmicrositetemplate')
    ...
    models = {
        ...
        'microsite_configuration.historicalmicrositetemplate': {
            'Meta': {'ordering': "(u'-history_date', u'-history_id')", 'object_name': 'HistoricalMicrositeTemplate'},
            u'history_date': ('django.db.models.fields.DateTimeField', [], {}),
            u'history_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'history_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'history_user': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            ...
            'template_uri': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'})
        },
        ...
        'microsite_configuration.micrositetemplate': {
            'Meta': {'unique_together': "(('microsite', 'template_uri'),)", 'object_name': 'MicrositeTemplate'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'microsite': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['microsite_configuration.Microsite']"}),
            'template': ('django.db.models.fields.TextField', [], {}),
            'template_uri': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'})
