...
class CourseModeModelTest(TestCase):
    ...
    def test_nodes_for_course_single(self):
        ...
        modes = CourseMode.modes_for_course(self.course_key)
        mode = Mode(u'verified', u'Verified Certificate', 0, '', 'usd', None, None, None, None)
    ...
    def test_modes_for_course_multiple(self):
        ...
        mode2 = Mode(u'verified', u'Verified Certificate', 0, '', 'usd', None, None, None, None)
    ...
    def test_modes_for_course_expired(self):
        ...
        expired_mode.save()
        expired_mode_value = Mode(u'verified', u'Verified Certificate', 0, '', 'usd', expiration_datetime, None, None, None)
        modes = CourseMode.modes_for_course(self.course_key)
