...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseMode.expiration_datetime_is_explicit'
        db.add_column('course_modes_coursemode', 'expiration_datetime_is_explicit',
    ...
    def backwards(self, orm):
        # Deleting field 'CourseMode.expiration_datetime_is_explicit'
        db.delete_column('course_modes_coursemode', 'expiration_datetime_is_explicit')
