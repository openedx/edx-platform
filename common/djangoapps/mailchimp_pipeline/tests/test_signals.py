...
from lms.djangoapps.onboarding.models import EmailPreference, UserExtendedProfile, GranteeOptIn
from lms.djangoapps.onboarding.tests.factories import UserFactory, EmailPreferenceFactory
...
class MailchimpPipelineSignalTestClass(TestCase):
    ...
    def setUp(self, mocked_nodebb_request):
    ...
    @patch("nodebb.signals.handlers.get_current_request", autospec=True)
    def test_sync_extended_profile_with_mailchimp(self, nodebb_request):
        """
