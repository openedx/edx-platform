# -*- coding: utf-8 -*-
# Generated by Django 1.11.28 on 2020-02-10 17:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id_type', models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='user_ids.ExternalIdType')),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user_ids.ExternalIdType'),
        ),
        migrations.AddField(
            model_name='externalid',
            name='user',
