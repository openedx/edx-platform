...
class ShibSPTest(ModuleStoreTestCase):
    ...
    def test_course_specific_login_and_reg(self):
        ...
        for domain in ["", "shib:https://idp.stanford.edu/"]:
            ...
            login_response = course_specific_login(login_request, SlashSeparatedCourseKey.from_string('MITx/999/Robot_Super_Course'))
            reg_response = course_specific_register(login_request, SlashSeparatedCourseKey.from_string('MITx/999/Robot_Super_Course'))
            ...
            login_response = course_specific_login(login_request, SlashSeparatedCourseKey.from_string('DNE/DNE/DNE'))
            reg_response = course_specific_register(login_request, SlashSeparatedCourseKey.from_string('DNE/DNE/DNE'))
