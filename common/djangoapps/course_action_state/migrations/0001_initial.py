...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_action_state_coursererunstate', (
            ...
            ('created_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_by_user+', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
            ('updated_user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='updated_by_user+', null=True, on_delete=models.SET_NULL, to=orm['auth.User'])),
    ...
    models = {
        ...
        'course_action_state.coursererunstate': {
            'Meta': {'object_name': 'CourseRerunState'},
            'action': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'course_key': ('xmodule_django.models.CourseKeyField', [], {'max_length': '255', 'db_index': 'True'}),
            'created_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_by_user+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'updated_user': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'updated_by_user+'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': "orm['auth.User']"})
        }
    }
