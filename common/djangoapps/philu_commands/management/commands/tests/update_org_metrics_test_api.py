# encoding: utf-8
"""
All test cases for management command `update_org_metric_prompts`
"""
...
def save_prompt(user, org, date):
    """
    Save and return OEF prompt

    Args:
        user (User): User object
        org (Organization): Organization object
        date (Date): Latest metric submission date

    Returns:
        OrganizationMetricUpdatePrompt: OEF prompt
    """
    prompt = OrganizationMetricUpdatePrompt(
