...
class EmbargoCourseFormTest(ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.true_form_data = {'course_id': unicode(self.course.id), 'embargoed': True}
        self.false_form_data = {'course_id': unicode(self.course.id), 'embargoed': False}
    ...
    def test_form_typo(self):
        # Munge course id
        bad_id = unicode(self.course.id) + '_typo'
    ...
    def test_invalid_location(self):
        # Munge course id
        bad_id = unicode(self.course.id).split('/')[-1]
