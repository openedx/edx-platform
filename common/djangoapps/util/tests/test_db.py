...
class MigrationTests(TestCase):
    ...
    """
    @unittest.skip(
        "Need to skip as part of renaming a field in schedules app. This will be unskipped in DE-1825. Also need to skip as part of removal of ProviderApiPermissions.This will be unskipped in BOM-1350"  # pylint: disable=line-too-long
    )
