...
class SandboxingTest(TestCase):
    ...
    def test_sandbox_exclusion(self):
        ...
        """
        self.assertFalse(can_execute_unsafe_code(CourseKey.from_string('edX/notful/empty')))
    ...
    def test_courses_with_unsafe_code_default(self):
        ...
        """
        self.assertFalse(can_execute_unsafe_code(CourseKey.from_string('edX/full/2012_Fall')))
        self.assertFalse(can_execute_unsafe_code(CourseKey.from_string('edX/full/2013_Spring')))
