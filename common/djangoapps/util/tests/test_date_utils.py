...
def test_get_default_time_display():
    ...
    test_time = datetime(1992, 3, 12, 15, 3, 30, tzinfo=get_utc_timezone())
...
def test_get_time_display_coerce():
    test_time_standard = datetime(1992, 1, 12, 15, 3, 30, tzinfo=get_utc_timezone())
    test_time_daylight = datetime(1992, 7, 12, 15, 3, 30, tzinfo=get_utc_timezone())
