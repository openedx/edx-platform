"""
Models for course enrollment aspects within User Information (students, staff, etc)
...
2. ./manage.py lms schemamigration course_enrollment --auto description_of_your_change
