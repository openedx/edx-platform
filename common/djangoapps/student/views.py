...
class LogoutView(TemplateView):
    ...
    def dispatch(self, request, *args, **kwargs):  # pylint: disable=missing-docstring
        ...
        self.oauth2_clients = Client.objects.exclude(logout_uri=None).values_list('logout_uri', flat=True)
        ...
        if len(self.oauth2_clients) > 0 or (LogoutViewConfiguration.current().enabled and self.oauth_client_ids):
