...
ENROLLMENT_REFUND_CONFIG = 'common.djangoapps.student.models.course_enrollment.EnrollmentRefundConfiguration.current'
...
class RefundableTest(SharedModuleStoreTestCase):
    ...
    def test_refund_cutoff_date(self, order_date_delta, course_start_delta, expected_date_delta, days):
        ...
        with patch(ENROLLMENT_REFUND_CONFIG) as config:
