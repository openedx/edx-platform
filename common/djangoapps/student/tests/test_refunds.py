...
class RefundableTest(SharedModuleStoreTestCase):
    ...
    @patch('common.djangoapps.student.models.student.CourseEnrollment.refund_cutoff_date')
    ...
    def test_refund_cutoff_date(self, order_date_delta, course_start_delta, expected_date_delta, days):
        ...
        with patch('common.djangoapps.student.models.student.EnrollmentRefundConfiguration.current') as config:
