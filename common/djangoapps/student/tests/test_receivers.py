...
from common.djangoapps.student.models.course_enrollment import CourseEnrollmentCelebration
from common.djangoapps.student.models.student import PendingNameChange, UserProfile
