...
class ExternalAuthShibTest(ModuleStoreTestCase):
    ...
    def test_externalauth_login_required_course_context(self):
        ...
        """
        TARGET_URL = reverse('courseware', args=[unicode(self.course.id)])            # pylint: disable=C0103
        ...
        TARGET_URL_SHIB = reverse('courseware', args=[unicode(self.shib_course.id)])  # pylint: disable=C0103
