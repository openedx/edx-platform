...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.nonregistered'
        db.add_column('auth_userprofile', 'nonregistered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.nonregistered'
        db.delete_column('auth_userprofile', 'nonregistered')
