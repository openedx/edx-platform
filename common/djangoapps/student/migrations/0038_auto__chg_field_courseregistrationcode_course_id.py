...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseRegistrationCode.course_id'
        db.alter_column('student_courseregistrationcode', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'CourseRegistrationCode.course_id'
        db.alter_column('student_courseregistrationcode', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        'student.courseregistrationcode': {
            ...
            'course_id': ('xmodule_django.models.CourseKeyField', [], {'max_length': '256', 'db_index': 'True'}),
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redeemed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 13, 0, 0)', 'null': 'True'}),
