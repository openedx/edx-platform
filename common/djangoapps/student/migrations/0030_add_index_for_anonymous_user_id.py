...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'AnonymousUsers', fields ['anonymous_user_id']
        db.create_index('student_anonymoususers', ['anonymous_user_id'])


    def backwards(self, orm):
        # Removing index on 'AnonymousUsers', fields ['anonymous_user_id']
        db.delete_index('student_anonymoususers', ['anonymous_user_id'])
    ...
    models = {
        ...
        'student.anonymoususers': {
            ...
            'anonymous_user_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '16', 'db_index': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
