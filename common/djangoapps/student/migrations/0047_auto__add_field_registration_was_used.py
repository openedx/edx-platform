...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Registration.was_used'
        db.add_column('auth_registration', 'was_used',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_index=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Registration.was_used'
        db.delete_column('auth_registration', 'was_used')
