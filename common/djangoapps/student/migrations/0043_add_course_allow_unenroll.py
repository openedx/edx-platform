...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'student.courseallowunenroll': {
            'Meta': {'unique_together': "(('course_id',),)", 'object_name': 'CourseAllowUnenroll'},
        ...
        'student.userprofile': {
            ...
            'grado_ocupacional': ('django.db.models.fields.CharField', [], {'default': "'none'", 'max_length': '64', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'institucion': ('django.db.models.fields.CharField', [], {'default': "'NINGUNO'", 'max_length': '128', 'null': 'True', 'blank': 'True'}),
