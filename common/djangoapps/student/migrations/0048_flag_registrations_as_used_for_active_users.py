...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        orm.Registration.objects.filter(user__is_active=False).update(was_used=True)

    def backwards(self, orm):
        orm.Registration.objects.all().update(was_used=False)
    ...
    models = {
        ...
        'student.registration': {
            ...
            'was_used': ('django.db.models.fields.BooleanField', [], {'default': 'False', 'db_index': 'True'})
        },
        'student.userprofile': {
