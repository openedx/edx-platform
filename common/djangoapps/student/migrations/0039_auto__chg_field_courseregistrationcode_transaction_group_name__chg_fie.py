...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseRegistrationCode.transaction_group_name'
        db.alter_column('student_courseregistrationcode', 'transaction_group_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'CourseRegistrationCode.course_id'
        db.alter_column('student_courseregistrationcode', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'CourseRegistrationCode.transaction_group_name'
        db.alter_column('student_courseregistrationcode', 'transaction_group_name', self.gf('django.db.models.fields.CharField')(max_length=256, null=True))
    ...
    models = {
        ...
        'student.courseregistrationcode': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'redeemed_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 20, 0, 0)', 'null': 'True'}),
