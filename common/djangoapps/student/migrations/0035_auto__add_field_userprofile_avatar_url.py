...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('auth_userprofile', 'avatar_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('auth_userprofile', 'avatar_url')
    ...
    models = {
        ...
        'student.userprofile': {
            ...
            'avatar_url': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
