...
def auth_pipeline_urls(auth_entry, redirect_url=None, course_id=None, email_opt_in=True):
    ...
    Keyword Args:
        ...
        email_opt_in (unicode): The user choice to opt in for organization wide emails.
