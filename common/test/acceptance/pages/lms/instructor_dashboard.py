...
class MembershipPageCohortManagementSection(PageObject):
    ...
    """
    url = None
    csv_browse_button_selector = '.cohort-management-file-upload #upload-file-form-file'
    csv_upload_button_selector = '.cohort-management-file-upload #upload-file-form-submit'
