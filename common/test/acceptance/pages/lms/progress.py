...
class ProgressPage(CoursePage):
    ...
    def _chapter_index(self, title):
        ...
        try:
            ...
            self.warning("Could not find chapter '{}'".format(title))
            return None
    ...
    def _section_index(self, chapter_index, title):
        ...
        section_css = '.chapters>section:nth-of-type({}) .sections div .hd a'.format(chapter_index)
        ...
        try:
            ...
            self.warning("Could not find section '{}'".format(title))
            return None
    ...
    def _aggregate_section_score(self, chapter_index, section_index):
        ...
        """
        score_css = ".chapters>section:nth-of-type({}) .sections>div:nth-of-type({}) .hd>span".format(
    ...
    def _section_scores(self, chapter_index, section_index):
        ...
        score_css = ".chapters>section:nth-of-type({}) .sections>div:nth-of-type({}) .scores>dd".format(
            chapter_index, section_index
        )
