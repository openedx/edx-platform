...
class RegisterFromCombinedPageTest(UniqueCourseTest):
    ...
    def test_register_success(self):
        ...
        self.assertEqual("WANT TO CHANGE YOUR ACCOUNT SETTINGS?", self.dashboard_page.sidebar_menu_title)
        self.assertEqual("Click the arrow next to your username above.", self.dashboard_page.sidebar_menu_description)
