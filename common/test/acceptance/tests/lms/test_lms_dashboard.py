...
class LmsDashboardCourseEntitlementTest(UniqueCourseTest, CatalogIntegrationMixin):
    ...
    def test_entitlement_session_selection(self):
        ...
        # Verify that clicking 'OK' in the session selection pop-up removes the Select Session button from the course
        # card and adds a View Course button and a 'Change or Leave Session' link.
        ...
        # Verify that selecting 'Leave the current session and decide later' changes the 'Change Session' button text to
    ...
    def test_refundable_can_unenroll(self):
        ...
        # Verify that selecting unenroll in the entitlement unenrollment modal triggers a DELETE request to the
        # appropriate API endpoint to revoke/refund the entitlement and redirects the user to the dashboard.
        assert True
