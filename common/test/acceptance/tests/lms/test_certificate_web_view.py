...
class CertificateProgressPageTest(UniqueCourseTest):
    ...
    def complete_course_problems(self):
        ...
        self.course_nav.q(css='fieldset field:nth-child(4) input').nth(0).click()

        # Select correct radio buttons for the answer
        self.course_nav.q(css='fieldset field:nth-child(2) input').nth(1).click()
        self.course_nav.q(css='fieldset field:nth-child(4) input').nth(1).click()
