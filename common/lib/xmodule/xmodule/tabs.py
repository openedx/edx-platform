...
class StaticTab(CourseTab):
    ...
    def __init__(self, tab_dict=None, name=None, url_slug=None):
        ...
        super(StaticTab, self).__init__(
            ...
            link_func=lambda course, reverse_func: reverse_func(self.type, args=[unicode(course.id), self.url_slug]),
        )
    ...
    def items(self, course):
        for index, textbook in enumerate(course.textbooks):
            yield SingleTextbookTab(
                ...
                link_func=lambda course, reverse_func: reverse_func('book', args=[unicode(course.id), index]),
            )
    ...
    def items(self, course):
        for index, textbook in enumerate(course.pdf_textbooks):
            yield SingleTextbookTab(
                ...
                link_func=lambda course, reverse_func: reverse_func('pdf_book', args=[unicode(course.id), index]),
            )
    ...
    def items(self, course):
        for index, textbook in enumerate(course.html_textbooks):
            yield SingleTextbookTab(
                ...
                link_func=lambda course, reverse_func: reverse_func('html_book', args=[unicode(course.id), index]),
            )
...
def link_reverse_func(reverse_name):
    ...
    """
    return lambda course, reverse_url_func: reverse_url_func(reverse_name, args=[unicode(course.id)])
