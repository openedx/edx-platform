...
from xmodule.modulestore.mixed import store_bulk_write_operations_on_course, store_branch_setting
...
def import_from_xml(
    ...
    course_items = []
    with store_branch_setting(store, ModuleStoreEnum.Branch.draft_preferred):
