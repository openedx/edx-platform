...
class SplitModuleCourseTests(SplitModuleTest):
    ...
    def test_get_courses(self, _from_json):
        ...
        self.assertEqual(len(course.tabs), 5, "wrong number of tabs")
        self.assertNotIn("course_info", [tab["type"] for tab in course.tabs], "should not contain course_info")
        self.assertEqual(
    ...
    def test_branch_requests(self, _from_json):
        ...
        def _verify_published_course(courses_published):
            ...
            self.assertEqual(course.category, 'course', 'wrong category')
            self.assertEqual(len(course.tabs), 3, "wrong number of tabs")
            self.assertNotIn("course_info", [tab["type"] for tab in course.tabs], "should not contain course_info")
...
class SplitModuleItemTests(SplitModuleTest):
    ...
    def test_get_item(self, _from_json):
        ...
        def verify_greek_hero(block):
            ...
            self.assertEqual(len(block.tabs), 5, "wrong number of tabs")
            self.assertNotIn("course_info", [tab["type"] for tab in block.tabs], "should not contain course_info")
