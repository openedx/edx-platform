...
class TestXMLModuleStore(unittest.TestCase):
    ...
    def test_unicode_chars_in_xml_content(self):
        ...
        errors = modulestore.get_course_errors(CourseLocator("edX", "toy", "2012_Fall"))
        assert errors == []
    ...
    def test_tilde_files_ignored(self, _fake_glob):
        ...
        about_location = CourseLocator('edX', 'tilde', '2012_Fall').make_usage_key(
            'about', 'index',
        )
    ...
    def test_get_courses_for_wiki(self):
        ...
        toy_course = store.get_course(CourseLocator('edX', 'toy', '2012_Fall'))
        ...
        for course_number in ['toy', 'simple']:
            self.assertIn(CourseLocator('edX', course_number, '2012_Fall'), course_locations)
    ...
    def test_has_course(self):
        ...
        check_has_course_method(
            ...
            CourseLocator('edX', 'toy', '2012_Fall'),
