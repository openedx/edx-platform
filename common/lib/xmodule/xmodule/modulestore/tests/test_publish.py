...
class TestPublish(SplitWMongoCourseBoostrapper):
    ...
    def _create_course(self):
        ...
        * some detached items
        ...
        with check_mongo_calls(self.draft_mongo, 8, 2):
        ...
        with self.draft_mongo.bulk_write_operations(self.old_course_key):
            ...
            with check_mongo_calls(self.draft_mongo, 6, 3):
            ...
            with check_mongo_calls(self.draft_mongo, 18, 8):
            ...
            with check_mongo_calls(self.draft_mongo, 44, 36):
