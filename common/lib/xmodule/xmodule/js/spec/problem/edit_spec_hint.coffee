  ...
  it 'multiple checkbox components', ->
    ...
    <choiceresponse>
      <checkboxgroup label="Select all the fruits from the list" direction="vertical">
        ...
        <booleanhint value="A*B">You're right that apple is a fruit, but there's one you're missing. Also, mushroom is not a fruit.</booleanhint>
        <booleanhint value="B*C">You're right that grape is a fruit, but there's one you're missing. Also, mushroom is not a fruit.</booleanhint>
      </checkboxgroup>
    </choiceresponse>
    ...
    <choiceresponse>
      <checkboxgroup label="Select all the vegetables from the list" direction="vertical">
        ...
        <booleanhint value="A*B">Making a banana split?</booleanhint>
        <booleanhint value="B*D">That will make a horrible dessert: a brussel sprout split?</booleanhint>
      </checkboxgroup>
    </choiceresponse>
...
describe 'text input components', ->
  ...
  it 'text input with or= with hints', ->
    ...
    <stringresponse answer="France" type="ci" >
      ...
      <additional_answer>USA<correcthint>hint2</correcthint></additional_answer>
  ...
  it 'with all question types', ->
    ...
    <choiceresponse>
      <checkboxgroup label="Checkboxes" direction="vertical">
        ...
        <booleanhint value="A*B">A*B hint</booleanhint>
      </checkboxgroup>
    </choiceresponse>
