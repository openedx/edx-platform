                ...
                this.tiny_mce_textarea = $(".tiny-mce", this.element).tinymce({
                    ...
                    */
                    ...
                    toolbar: "formatselect | fontselect | bold italic underline forecolor wrapAsCode | " +
                        "bullist numlist outdent indent blockquote | link unlink image | code",
					
                    block_formats: gettext("Paragraph") + "=p;" + gettext("Preformatted") + "=pre;" + 
                        gettext("Heading 3") + "=h3;" + gettext("Heading 4") + "=h4;" + gettext("Heading 5") + "=h5;" + 
                        gettext("Heading 6") + "=h6",
//                     block_formats: edx.StringUtils.interpolate("{paragraph}=p;{preformatted}=pre;{heading3}=h3;{heading4}=h4;{heading5}=h5;{heading6}=h6", {
...
//                     }, true),
                ...
                tinymce.addI18n('en', {
                    /*
                    Translators: this is a message from the raw HTML editor displayed in the browser when a user needs 
                    to edit HTML
                    */
