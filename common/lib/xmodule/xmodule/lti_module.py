...
class LTIModule(LTIFields, LTI20ModuleMixin, XModule):
    ...
    def get_resource_link_id(self):
        ...
        """
        return str(urllib.parse.quote("{}-{}".format(self.system.hostname, self.location.html_id())))
...
oauth_consumer_key="", oauth_signature="frVp4JuvT1mVXlxktiAUjQ7%2F1cw%3D"'}
        ...
        params['oauth_signature'] = urllib.parse.unquote(params['oauth_signature']).decode('utf8')
    ...
    def grade_handler(self, request, suffix):  # pylint: disable=unused-argument
        ...
        real_user = self.system.get_real_user(urllib.parse.unquote(sourcedId.split(':')[-1]))
    ...
    def verify_oauth_body_sign(self, request, content_type='application/x-www-form-urlencoded'):
        ...
        mock_request_lti_1 = mock.Mock(
            uri=str(urllib.parse.unquote(self.get_outcome_service_url())),
