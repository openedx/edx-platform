...
class TabTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.course.id = CourseKey.from_string('edX/toy/2012_Fall')
...
class ProgressTestCase(TabTestCase):
    ...
    def check_progress_tab(self):
        ...
        return self.check_tab(
            ...
            expected_link=self.reverse('progress', args=[unicode(self.course.id)]),
...
class WikiTestCase(TabTestCase):
    ...
    def check_wiki_tab(self):
        ...
        return self.check_tab(
            ...
            expected_link=self.reverse('course_wiki', args=[unicode(self.course.id)]),
...
class StaticTabTestCase(TabTestCase):
    ...
    def test_static_tab(self):
        ...
        tab = self.check_tab(
            ...
            expected_link=self.reverse('static_tab', args=[unicode(self.course.id), url_slug]),
        ...
        for tab in tabs.CourseTabList.iterate_displayable(self.course, self.settings):
            ...
            if isinstance(tab, tabs.SingleTextbookTab):
                ...
                expected_link = self.reverse(
                    ...
                    args=[unicode(self.course.id), book_index]
                )
                self.assertEqual(tab.link_func(self.course, self.reverse), expected_link)
...
class GradingTestCase(TabTestCase):
    ...
    def check_grading_tab(self, tab_class, name, link_value):
        ...
        return self.check_tab(
            ...
            expected_name=name,
            expected_link=self.reverse(link_value, args=[unicode(self.course.id)]),
...
class NotesTestCase(TabTestCase):
    ...
    def check_notes_tab(self):
        ...
        return self.check_tab(
            ...
            expected_link=self.reverse('notes', args=[unicode(self.course.id)]),
...
class SyllabusTestCase(TabTestCase):
    ...
    def check_syllabus_tab(self, expected_can_display_value):
        ...
        tab = self.check_tab(
            ...
            expected_name=name,
            expected_link=self.reverse('syllabus', args=[unicode(self.course.id)]),
...
class InstructorTestCase(TabTestCase):
    ...
    def test_instructor_tab(self):
        ...
        tab = self.check_tab(
            ...
            expected_name=name,
            expected_link=self.reverse('instructor_dashboard', args=[unicode(self.course.id)]),
