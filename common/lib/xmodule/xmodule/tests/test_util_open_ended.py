...
{ "accept_file_upload" : false,
  ...
  "task_states" : [ { "child_attempts" : 4,
        "child_created" : false,
        "child_history" : [ { "answer" : "After 24 hours, remove the samples from the containers and rinse each sample with distilled water.rnAllow the samples to sit and dry for 30 minutes.rnDetermine the mass of each sample.rnThe studentsu2019 data are recorded in the table below.rnrnStarting Mass (g)tEnding Mass (g)tDifference in Mass (g)rnMarblet 9.8t 9.4tu20130.4rnLimestonet10.4t 9.1tu20131.3rnWoodt11.2t11.2t 0.0rnPlastict 7.2t 7.1tu20130.1rnAfter reading the",
              "post_assessment" : [ 3 ],
              "score" : 1
            },
            { "answer" : "To replicate the experiment, the procedure would require more detail. One piece of information that is omitted is the amount of vinegar used in the experiment. It is also important to know what temperature the experiment was kept at during the 24 hours. Finally, the procedure needs to include details about the experiment, for example if the whole sample must be submerged.",
              "post_assessment" : [ 3 ],
              "score" : 1
            },
            { "answer" : "e the mass of four different samples.rnPour vinegar in each of four separate, but identical, containers.rnPlace a sample of one material into one container and label. Repeat with remaining samples, placing a single sample into a single container.rnAfter 24 hours, remove the samples from the containers and rinse each sample with distilled water.rnAllow the samples to sit and dry for 30 minutes.rnDetermine the mass of each sample.rnThe studentsu2019 data are recorded in the table below.rn",
              "post_assessment" : [ 3 ],
              "score" : 1
            },
            { "answer" : "",
      ...
      { "child_attempts" : 0,
        "child_created" : false,
        "child_history" : [ { "answer" : "The studentsu2019 data are recorded in the table below.rnrnStarting Mass (g)tEnding Mass (g)tDifference in Mass (g)rnMarblet 9.8t 9.4tu20130.4rnLimestonet10.4t 9.1tu20131.3rnWoodt11.2t11.2t 0.0rnPlastict 7.2t 7.1tu20130.1rnAfter reading the groupu2019s procedure, describe what additional information you would need in order to replicate the expe",
              "post_assessment" : { "feedback" : { "grammar" : "Grammar: More grammar errors than average.",
                      "markup-text" : "the students data are recorded in the <bg>table below . starting mass</bg> g ending mass g difference in mass g marble . . . limestone . . . wood . . . plastic . . . after reading the groups <bg>procedure , describe what additional</bg> information you would need in order to replicate the <bs>expe</bs>",
                      "spelling" : "Spelling: Ok."
                    },
                  "grader_id" : 3233,
                  "grader_type" : "ML",
                  "rubric_scores_complete" : true,
                  "rubric_xml" : "<rubric><category><description>Response Quality</description><score>0</score><option points='0'>The response is not a satisfactory answer to the question.  It either fails to address the question or does so in a limited way, with no evidence of higher-order thinking.</option><option points='1'>The response is a marginal answer to the question.  It may contain some elements of a proficient response, but it is inaccurate or incomplete.</option><option points='2'>The response is a proficient answer to the question.  It is generally correct, although it may contain minor inaccuracies.  There is limited evidence of higher-order thinking.</option><option points='3'>The response is correct, complete, and contains evidence of higher-order thinking.</option></category></rubric>",
                  "score" : 0,
                  "submission_id" : 3097,
                  "success" : true
                },
            ...
            { "answer" : "After 24 hours, remove the samples from the containers and rinse each sample with distilled water.rnAllow the samples to sit and dry for 30 minutes.rnDetermine the mass of each sample.rnThe studentsu2019 data are recorded in the table below.rnrnStarting Mass (g)tEnding Mass (g)tDifference in Mass (g)rnMarblet 9.8t 9.4tu20130.4rnLimestonet10.4t 9.1tu20131.3rnWoodt11.2t11.2t 0.0rnPlastict 7.2t 7.1tu20130.1rnAfter reading the",
              "post_assessment" : { "feedback" : { "grammar" : "Grammar: Ok.",
                      "markup-text" : "after hours , remove the samples from the containers and rinse each sample with distilled water . allow the samples to sit and dry for minutes . determine the mass of each sample . the students data are recorded in the <bg>table below . starting mass</bg> g ending mass g difference in mass g marble . . . limestone . . . wood . . . plastic . . . after reading the",
                      "spelling" : "Spelling: Ok."
                    },
                  "grader_id" : 3235,
                  "grader_type" : "ML",
            ...
            { "answer" : "To replicate the experiment, the procedure would require more detail. One piece of information that is omitted is the amount of vinegar used in the experiment. It is also important to know what temperature the experiment was kept at during the 24 hours. Finally, the procedure needs to include details about the experiment, for example if the whole sample must be submerged.",
              "post_assessment" : { "feedback" : { "grammar" : "Grammar: Ok.",
                      "markup-text" : "to replicate the experiment , the procedure would require <bg>more detail . one</bg> piece of information <bg>that is omitted is the</bg> amount of vinegar used in the experiment . it is also important to know what temperature the experiment was kept at during the hours . finally , the procedure needs to include details about the experiment , for example if the whole sample must be submerged .",
                      "spelling" : "Spelling: Ok."
                    },
                  "grader_id" : 3237,
                  "grader_type" : "ML",
            ...
            { "answer" : "e the mass of four different samples.rnPour vinegar in each of four separate, but identical, containers.rnPlace a sample of one material into one container and label. Repeat with remaining samples, placing a single sample into a single container.rnAfter 24 hours, remove the samples from the containers and rinse each sample with distilled water.rnAllow the samples to sit and dry for 30 minutes.rnDetermine the mass of each sample.rnThe studentsu2019 data are recorded in the table below.rn",
              "post_assessment" : { "feedback" : { "grammar" : "Grammar: Ok.",
                      "markup-text" : "e the mass of four different samples . pour vinegar in <bg>each of four separate</bg> , but identical , containers . place a sample of one material into one container and label . repeat with remaining samples , placing a single sample into a single container . after hours , remove the samples from the containers and rinse each sample with distilled water . allow the samples to sit and dry for minutes . determine the mass of each sample . the students data are recorded in the table below . ",
                      "spelling" : "Spelling: Ok."
                    },
                  "grader_id" : 3239,
                  "grader_type" : "ML",
        ...
        "child_history" : [ { "answer" : "The studentsu2019 data are recorded in the table below.rnrnStarting Mass (g)tEnding Mass (g)tDifference in Mass (g)rnMarblet 9.8t 9.4tu20130.4rnLimestonet10.4t 9.1tu20131.3rnWoodt11.2t11.2t 0.0rnPlastict 7.2t 7.1tu20130.1rnAfter reading the groupu2019s procedure, describe what additional information you would need in order to replicate the expe",
            ...
            { "answer" : "To replicate the experiment, the procedure would require more detail. One piece of information that is omitted is the amount of vinegar used in the experiment. It is also important to know what temperature the experiment was kept at during the 24 hours. Finally, the procedure needs to include details about the experiment, for example if the whole sample must be submerged.",
              "post_assessment" : { "feedback" : { "grammar" : "Grammar: Ok.",
                  ...
                  "grader_type" : "PE",
                  "rubric_scores_complete" : true,
                  "rubric_xml" : "<rubric><category><description>Response Quality</description><score>5</score><option points='0'>The response is not a satisfactory answer to the question.  It either fails to address the question or does so in a limited way, with no evidence of higher-order thinking.</option><option points='1'>The response is a marginal answer to the question.  It may contain some elements of a proficient response, but it is inaccurate or incomplete.</option><option points='2'>The response is a proficient answer to the question.  It is generally correct, although it may contain minor inaccuracies.  There is limited evidence of higher-order thinking.</option><option points='3'>The response is correct, complete, and contains evidence of higher-order thinking.</option></category></rubric>",
                  "score" : 2,
                  "submission_id" : 3099,
                  "success" : true
                },
      ...
      { "child_attempts" : 0,
        ...
        "child_history" : [ { "answer" : "The studentsu2019 data are recorded in the table below.rnrnStarting Mass (g)tEnding Mass (g)tDifference in Mass (g)rnMarblet 9.8t 9.4tu20130.4rnLimestonet10.4t 9.1tu20131.3rnWoodt11.2t11.2t 0.0rnPlastict 7.2t 7.1tu20130.1rnAfter reading the groupu2019s procedure, describe what additional information you would need in order to replicate the expe",
              "post_assessment" : { "feedback" : { "grammar" : "Grammar: More grammar errors than average.",
                  ...
                  "grader_type" : "ML",
                  "rubric_scores_complete" : true,
                  "rubric_xml" : "<rubric><category><description>Response Quality</description><score>2</score><option points='0'>The response is not a satisfactory answer to the question.  It either fails to address the question or does so in a limited way, with no evidence of higher-order thinking.</option><option points='1'>The response is a marginal answer to the question.  It may contain some elements of a proficient response, but it is inaccurate or incomplete.</option><option points='2'>The response is a proficient answer to the question.  It is generally correct, although it may contain minor inaccuracies.  There is limited evidence of higher-order thinking.</option><option points='3'>The response is correct, complete, and contains evidence of higher-order thinking.</option></category></rubric>",
                  "score" : 0,
                  "submission_id" : 3097,
                  "success" : true
                },
