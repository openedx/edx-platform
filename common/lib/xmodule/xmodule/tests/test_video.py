...
def mock_val_export(edx_video_id, course_id, external):
    """Mock edxval.api.export_to_xml"""
    return etree.Element('video_asset')
...
class VideoDescriptorImportTestCase(unittest.TestCase):
    ...
    def test_import_val_data(self, mock_val_api_import_from_xml):
        ...
        mock_val_api_import_from_xml.assert_called_once_with(
            ANY,
            'test_edx_video_id',
...
class VideoExportTestCase(VideoDescriptorTestBase):
    ...
    def test_export_to_xml(self, mock_val_api_export_to_xml):
        ...
        mock_val_api_export_to_xml.assert_called_once_with(
