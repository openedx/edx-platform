...
class ContentTest(unittest.TestCase):
    def test_thumbnail_none(self):
        ...
        # all elements being None. It is important that the location be just
        # None for rendering.
        content = StaticContent(
            'loc', 'name', 'content_type', 'data', None, None, None)
    ...
    def test_compute_location(self):
        ...
        asset_location = StaticContent.compute_location(
            'mitX', '400', 'subs__1eo_jXvZnE .srt.sjson')
        self.assertEqual(Location(u'c4x', u'mitX', u'400', u'asset',
                         u'subs__1eo_jXvZnE_.srt.sjson', None), asset_location)
