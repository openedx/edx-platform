...
class StudioValidationMessageTest(unittest.TestCase):
    ...
    def test_bad_parameters(self):
        ...
        with pytest.raises(TypeError):
            StudioValidationMessage(StudioValidationMessage.WARNING, "bad warning", action_label="Non-unicode string")
    ...
    def test_to_json(self):
        ...
        self.assertEqual(
            ...
            StudioValidationMessage(
                StudioValidationMessage.NOT_CONFIGURED, "Not Configured message", action_label="Action label"
            ).to_json()
        )
        ...
        self.assertEqual(
            ...
            StudioValidationMessage(
                StudioValidationMessage.WARNING, "Warning message", action_class="class-for-action"
            ).to_json()
        )
        ...
        self.assertEqual(
            ...
            StudioValidationMessage(
                StudioValidationMessage.ERROR, "Error message", action_runtime_event="do-fix-up"
            ).to_json()
        )
...
class StudioValidationTest(unittest.TestCase):
    ...
    def test_add_messages(self):
        ...
        self.assertEqual("Not configured", validation_1.messages[1].text)

        self.assertEqual(StudioValidationMessage.WARNING, validation_1.summary.type)
        self.assertEqual("Summary message", validation_1.summary.text)
    ...
    def test_set_summary_accepts_validation_message(self):
        ...
        self.assertEqual("Summary message", validation.summary.text)
