...
class LatexRenderedTest(unittest.TestCase):
    ...
    def test_simple(self):
        ...
        self.assertEqual(obj.latex, math)
        self.assertEqual(obj.sans_parens, math)
        self.assertEqual(obj.tall, True)
    ...
    def _each_parens(self, with_parens, math, parens, tall=False):
        ...
        self.assertEqual(obj.latex, with_parens)
        self.assertEqual(obj.sans_parens, math)
        self.assertEqual(obj.tall, tall)
    ...
    def test_bad_parens(self):
        ...
        with self.assertRaisesRegex(Exception, 'Unknown parenthesis'):
...
class LatexPreviewTest(unittest.TestCase):
    ...
    def test_no_input(self):
        ...
        """
        self.assertEqual('', preview.latex_preview(''))
        self.assertEqual('', preview.latex_preview('  '))
        self.assertEqual('', preview.latex_preview(' \t '))

    def test_number_simple(self):
        """ Simple numbers should pass through. """
        self.assertEqual(preview.latex_preview('3.1415'), '3.1415')

    def test_number_suffix(self):
        """ Suffixes should be escaped. """
        self.assertEqual(preview.latex_preview('1.618%'), r'1.618\text{%}')
    ...
    def test_variable_simple(self):
        ...
        self.assertEqual(preview.latex_preview('x', variables=['x']), 'x')

    def test_greek(self):
        """ Variable names that are greek should be formatted accordingly. """
        self.assertEqual(preview.latex_preview('pi'), r'\pi')
    ...
    def test_function_sqrt(self):
        ...
        self.assertEqual(preview.latex_preview('sqrt(3)'), r'\sqrt{3}')
    ...
    def test_syntax_errors(self):
        ...
        self.assertEqual({}, bad_exceptions)
