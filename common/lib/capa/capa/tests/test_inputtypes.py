...
class MatlabTest(unittest.TestCase):
    ...
    def test_get_html(self):
        ...
        self.assertEqual(
            ...
            " ".join(textwrap.dedent("""<div>{\'status\': Status(\'queued\'), \'button_enabled\': True,
            \'rows\': \'10\', \'queue_len\': \'3\', \'question_label\': \'\', \'mode\': \'\', \'cols\': \'80\',
            \'STATIC_URL\': \'/dummy-static/\', \'linenumbers\': \'true\', \'queue_msg\': \'\',
            \'value\': \'print "good evening"\', \'duplicate_question\': \'\',
            ...
            \'id\': \'prob_1_2\', \'tabsize\': 4}</div>""").replace('\n', '').split())
        )
