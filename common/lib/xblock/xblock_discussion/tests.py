...
class TestStudentView(TestDiscussionXblock):
    ...
    def setUp(self):
        ...
        self.block._student_view_lms = mock.Mock()
        self.block._student_view_studio = mock.Mock()
    ...
    def test_defaults_to_student_view_if_no_xmodule_runtime(self):
        ...
        self.assertTrue(self.block._student_view_lms.called)
        self.assertFalse(self.block._student_view_studio.called)
    ...
    def test_returns_studio_view_when_in_studio(self):
        ...
        self.block.student_view()
        self.assertTrue(self.block._student_view_studio.called)
        self.assertFalse(self.block._student_view_lms.called)
...
class TestGetDjangoUser(TestDiscussionXblock):
    ...
    def setUp(self):
        ...
        self.django_user = "canary"
        self.user_service = mock.Mock()
        self.user_service._django_user = self.django_user
...
class TestViews(TestDiscussionXblock):
    ...
    def test_js_contents(self):
        ...
        expected_resource = FragmentResource(kind='text', data=test_javascript, mimetype='application/javascript', placement='foot')
