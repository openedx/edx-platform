define([
    ...
    'cms/static/common/js/spec_helpers/page_helpers',
    'cms/static/common/js/spec_helpers/template_helpers',
    'cms/static/course_search/js/models/search_result',
    'cms/static/course_search/js/collections/search_collection',
    'cms/static/course_search/js/search_router',
    'cms/static/course_search/js/views/search_form',
    'cms/static/course_search/js/views/search_item_view',
    'cms/static/course_search/js/views/course_search_results_view',
    'cms/static/course_search/js/views/dashboard_search_results_view',
    'cms/static/course_search/js/course_search_factory',
    'cms/static/course_search/js/dashboard_search_factory',
    'text!cms/static/course_search/templates/course_search_item.underscore'
], function(
    $,
    Backbone,
    Logger,
