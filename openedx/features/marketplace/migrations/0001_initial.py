    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_services', openedx.custom.db.fields.MultiSelectWithOtherField(choices=[(b'healthcare-supplies', 'Healthcare Supplies'), (b'people-power', 'People Power'), (b'online-training', 'Online Training'), (b'delivery-services', 'Delivery Services'), (b'mentorship', 'Mentorship'), (b'funding', 'Funding'), (b'human-resources', 'Human Resources'), (b'other', b'Other')], help_text='Please select all that apply.', max_length=151, verbose_name='What help can you provide to other organizations?')),
