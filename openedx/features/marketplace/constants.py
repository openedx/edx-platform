...
ORG_PROBLEM_TEMPLATE_CHOICES = [ORG_PROBLEM_TYPE_OTHER, _('Other')]
ORG_PROBLEM_TEMPLATE_CHOICES.extend(ORG_PROBLEM_CHOICES)
...
ORG_SECTOR_TEMPLATE_CHOICES.extend(ORG_SECTOR_CHOICES)
