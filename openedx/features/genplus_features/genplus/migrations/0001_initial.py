    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('running', models.FileField(help_text='Provide running position of character', upload_to='gen_plus_avatars', validators=[openedx.features.genplus_features.genplus.models.validate_file_extension])),
                ('crouching', models.FileField(help_text='Provide crouching position of character', upload_to='gen_plus_avatars', validators=[openedx.features.genplus_features.genplus.models.validate_file_extension])),
                ('jumping', models.FileField(help_text='Provide jumping position of character', upload_to='gen_plus_avatars', validators=[openedx.features.genplus_features.genplus.models.validate_file_extension])),
            ],
        ),
        migrations.CreateModel(
            name='Class',
