# -*- coding: utf-8 -*-
# Generated by Django 1.11.21 on 2020-04-24 12:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='job',
            name='compensation',
            field=models.CharField(choices=[(b'volunteer', b'Volunteer'), (b'hourly', b'Hourly'), (b'salaried', b'Salaried')], default=0, help_text='Please select the type of compensation you are offering for this job.', max_length=255, verbose_name='Compensation'),
        ),
        migrations.AlterField(
            model_name='job',
            name='contact_email',
        ...
        migrations.AlterField(
            model_name='job',
            name='hours',
            field=models.CharField(choices=[(b'fulltime', b'Full Time'), (b'parttime', b'Part Time'), (b'freelance', b'Freelance')], default=0, help_text='Please select the expected number of working hours required for this job.', max_length=255, verbose_name='Job Hours'),
        ),
        migrations.AlterField(
            model_name='job',
            name='logo',
            field=models.ImageField(blank=True, help_text="Please upload a file with your company's logo. (maximum 2 MB)", null=True, upload_to='job-board/uploaded-logos/', validators=[django.core.validators.FileExtensionValidator([b'jpg', b'png']), openedx.features.job_board.helpers.validate_file_size], verbose_name='Company Logo'),
        ),
        migrations.AlterField(
            model_name='job',
        ...
        migrations.AlterField(
            model_name='job',
            name='type',
            field=models.CharField(choices=[(b'remote', b'Remote'), (b'onsite', b'Onsite')], default=0, help_text='Please select whether the job is onsite or can be done remotely.', max_length=255, verbose_name='Job Type'),
        ),
        migrations.AlterField(
            model_name='job',
            name='website_link',
