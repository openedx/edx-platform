...
from openedx.tests.acceptance.pages.lms.discussion import InlineDiscussionPage
from openedx.tests.acceptance.pages.common.paging import PaginatedUIMixin
from openedx.tests.acceptance.pages.common.utils import confirm_prompt

from openedx.tests.acceptance.pages.lms.fields import FieldsMixin
