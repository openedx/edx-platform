...
from openedx.tests.acceptance.pages.lms.login import LoginPage
from openedx.tests.acceptance.pages.lms.progress import ProgressPage
from openedx.tests.acceptance.pages.common.logout import LogoutPage
from openedx.tests.acceptance.fixtures.course import CourseFixture, XBlockFixtureDesc, CourseUpdateDesc
from openedx.tests.acceptance.tests.helpers import UniqueCourseTest, load_data_str
