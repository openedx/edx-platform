...
from openedx.tests.acceptance.tests.helpers import UniqueCourseTest, EventsTestMixin
from openedx.tests.acceptance.pages.lms.auto_auth import AutoAuthPage
from openedx.tests.acceptance.pages.lms.ccx_dashboard_page import CoachDashboardPage
