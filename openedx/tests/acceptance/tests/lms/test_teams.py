...
from openedx.tests.acceptance.tests.helpers import get_modal_alert, EventsTestMixin, UniqueCourseTest
...
from openedx.tests.acceptance.pages.lms.teams import (
    TeamsPage,
    MyTeamsPage,
    BrowseTopicsPage,
    BrowseTeamsPage,
