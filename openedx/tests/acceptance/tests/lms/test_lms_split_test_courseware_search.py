...
from openedx.tests.acceptance.tests.helpers import remove_file
from openedx.tests.acceptance.pages.common.logout import LogoutPage
from openedx.tests.acceptance.pages.studio.overview import CourseOutlinePage
from openedx.tests.acceptance.pages.lms.courseware_search import CoursewareSearchPage
from openedx.tests.acceptance.pages.lms.course_nav import CourseNavPage
...
from openedx.tests.acceptance.pages.studio.auto_auth import AutoAuthPage as StudioAutoAuthPage
