...
"""
from openedx.tests.acceptance.tests.helpers import UniqueCourseTest, EventsTestMixin, load_data_str, get_element_padding
...
from openedx.tests.acceptance.pages.lms.certificate_page import CertificatePage
