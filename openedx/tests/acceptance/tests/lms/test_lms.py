...
from openedx.tests.acceptance.pages.lms.login_and_register import CombinedLoginAndRegisterPage, ResetPasswordPage
...
from openedx.tests.acceptance.pages.lms.course_wiki import CourseWikiPage, CourseWikiEditPage
