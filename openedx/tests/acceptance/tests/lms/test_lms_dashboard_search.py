...
from openedx.tests.acceptance.tests.helpers import generate_course_key
...
from openedx.tests.acceptance.pages.studio.utils import add_html_component, type_in_codemirror
...
from openedx.tests.acceptance.pages.lms.dashboard_search import DashboardSearchPage
