...
from openedx.tests.acceptance.pages.lms.bookmarks import BookmarksPage
...
from openedx.tests.acceptance.tests.helpers import EventsTestMixin, UniqueCourseTest, is_404_page
