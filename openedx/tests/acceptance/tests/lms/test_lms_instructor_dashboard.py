...
from openedx.tests.acceptance.tests.helpers import UniqueCourseTest, get_modal_alert, EventsTestMixin
...
from openedx.tests.acceptance.pages.lms.create_mode import ModeCreationPage
...
from openedx.tests.acceptance.pages.lms.track_selection import TrackSelectionPage
from openedx.tests.acceptance.pages.lms.pay_and_verify import PaymentAndVerificationFlow, FakePaymentPage
...
from openedx.tests.acceptance.fixtures.certificates import CertificateConfigFixture
