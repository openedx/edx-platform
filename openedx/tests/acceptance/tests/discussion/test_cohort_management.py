...
from openedx.tests.acceptance.tests.discussion.helpers import CohortTestMixin
from openedx.tests.acceptance.tests.helpers import UniqueCourseTest, EventsTestMixin, create_user_partition_json
...
from openedx.tests.acceptance.pages.lms.instructor_dashboard import InstructorDashboardPage, DataDownloadPage
from openedx.tests.acceptance.pages.studio.settings_group_configurations import GroupConfigurationsPage
