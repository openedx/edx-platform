...
from openedx.tests.acceptance.pages.studio.component_editor import ComponentVisibilityEditorView
...
from openedx.tests.acceptance.pages.lms.auto_auth import AutoAuthPage as LmsAutoAuthPage
from openedx.tests.acceptance.tests.lms.test_lms_user_preview import verify_expected_problem_visibility
