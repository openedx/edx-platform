...
from openedx.tests.acceptance.pages.studio.component_editor import ComponentEditorView, ComponentVisibilityEditorView
from openedx.tests.acceptance.pages.studio.container import ContainerPage
from openedx.tests.acceptance.pages.studio.html_component_editor import HtmlComponentEditorView
from openedx.tests.acceptance.pages.studio.utils import add_discussion, drag
from openedx.tests.acceptance.pages.lms.courseware import CoursewarePage
from openedx.tests.acceptance.pages.lms.staff_view import StaffPage
from openedx.tests.acceptance.tests.helpers import create_user_partition_json
