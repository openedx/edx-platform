...
from openedx.tests.acceptance.tests.helpers import create_user_partition_json, element_has_text
...
from openedx.tests.acceptance.pages.studio.utils import get_input_value
