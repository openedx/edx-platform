...
from openedx.tests.acceptance.fixtures.catalog import CatalogFixture, CatalogConfigMixin
from openedx.tests.acceptance.fixtures.programs import ProgramsFixture, ProgramsConfigMixin
