...
from openedx.tests.acceptance.pages.studio.course_info import CourseUpdatesPage
from openedx.tests.acceptance.pages.studio.edit_tabs import PagesPage
from openedx.tests.acceptance.pages.studio.import_export import ExportCoursePage, ImportCoursePage
from openedx.tests.acceptance.pages.studio.index import DashboardPage, HomePage, IndexPage
from openedx.tests.acceptance.pages.studio.login import LoginPage, CourseOutlineSignInRedirectPage
from openedx.tests.acceptance.pages.studio.overview import CourseOutlinePage
from openedx.tests.acceptance.pages.studio.asset_index import AssetIndexPage
from openedx.tests.acceptance.pages.studio.settings import SettingsPage
from openedx.tests.acceptance.pages.studio.settings_advanced import AdvancedSettingsPage
from openedx.tests.acceptance.pages.studio.settings_graders import GradingPage
from openedx.tests.acceptance.pages.studio.signup import SignupPage
from openedx.tests.acceptance.pages.studio.textbook_upload import TextbookUploadPage
from openedx.tests.acceptance.pages.studio.users import CourseTeamPage
