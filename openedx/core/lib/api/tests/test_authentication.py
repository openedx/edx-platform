...
urlpatterns = [
    path('oauth2-inactive-test/', MockView.as_view(authentication_classes=[authentication.BearerAuthenticationAllowInactiveUser])
    ),
    path('oauth2-test/', MockView.as_view(authentication_classes=[authentication.BearerAuthentication])
    )
]
