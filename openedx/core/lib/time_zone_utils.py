...
def _format_time_zone_string(time_zone, date_time, format_string):
    ...
    :param time_zone: ZoneInfo time zone object
...
def get_time_zone_abbr(time_zone, date_time=None):
    ...
    """
    date_time = datetime.now(ZoneInfo("UTC")) if date_time is None else date_time
...
def get_display_time_zone(time_zone_name):
    ...
    :param time_zone_name (str): Name of IANA time zone
    """
