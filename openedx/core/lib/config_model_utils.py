...
class GlobalStackedConfigurationModel(StackedConfigurationModel):
    class Meta(object):
        abstract = True


class SiteStackedConfigurationModel(StackedConfigurationModel):
    class Meta(object):
        abstract = True
...
class OrgStackedConfigurationModel(StackedConfigurationModel):
    class Meta(object):
        abstract = True
...
class CourseStackedConfigurationModel(StackedConfigurationModel):
    class Meta(object):
        abstract = True
