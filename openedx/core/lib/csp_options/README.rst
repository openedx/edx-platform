Content-Security-Policy Options Middleware
**************************
...
- Add the middleware ``'openedx.core.lib.csp_options.middleware.EdxCSPOptionsMiddleware'`` near the end of your ``MIDDLEWARE`` list.
