...
class RestrictedApplication(models.Model):
    ...
    application = models.ForeignKey(oauth2_settings.APPLICATION_MODEL, db_constraint=False, null=False, on_delete=models.CASCADE)
...
class ApplicationOrganization(models.Model):
    ...
    application = models.ForeignKey(oauth2_settings.APPLICATION_MODEL, db_constraint=False, related_name='organizations')
