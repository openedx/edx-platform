# -*- coding: utf-8 -*-
# Generated by Django 1.11.13 on 2018-06-22 15:30
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ApplicationOrganizationFilter',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('provider_type', models.CharField(choices=[(b'content_org', 'Content Provider')], default=b'content_org', max_length=32)),
                ('application', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='org_filters', to=settings.OAUTH2_PROVIDER_APPLICATION_MODEL)),
