...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        while courses:
            ...
            log.info('COURSE-NOTIFICATIONS: date_now: %s, course_start_date: %s',
                date_now,
                course_start_date,
                )

            if course.end:
                log.info('COURSE-NOTIFICATIONS: course_end_date: %s', course.end.date())

            log.info("Finishing email task")
