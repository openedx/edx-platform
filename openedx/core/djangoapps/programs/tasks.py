    ...
    if new_program_uuids:
        ...
        for program_uuid in new_program_uuids:
            ...
            try:
                ...
                LOGGER.exception(
                    u"""Certificate for program {uuid} could not be found. Unable to award certificate to user  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=line-too-long, logging-format-interpolation
                ...
                if exc.response.status_code == 429:  # lint-amnesty, pylint: disable=no-else-raise, no-member
                    ...
                    LOGGER.info(
                        u"""Rate limited. Retrying task to award certificates to user {username} in {countdown}  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=line-too-long, logging-format-interpolation
                    ...
                    LOGGER.exception(
                        u"""Unable to award certificate to user {username} for program {uuid}. The program might not be  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=line-too-long, logging-format-interpolation
    ...
    if program_uuids_to_revoke:
        ...
        for program_uuid in program_uuids_to_revoke:
            try:
                ...
                LOGGER.exception(
                    u"""Certificate for program {uuid} could not be found. Unable to revoke certificate for user  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=line-too-long, logging-format-interpolation
                ...
                if exc.response.status_code == 429:  # pylint: disable=no-member, no-else-raise
                    rate_limit_countdown = 60
                    LOGGER.info(
                        u"""Rate limited. Retrying task to revoke certificates for user {username} in {countdown}  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=logging-format-interpolation  # lint-amnesty, pylint: disable=line-too-long, logging-format-interpolation
                        seconds""".format(username=username, countdown=rate_limit_countdown)
                    )
                    # Retry after 60 seconds, when we should be in a new throttling window
                    raise self.retry(exc=exc, countdown=rate_limit_countdown, max_retries=MAX_RETRIES)
