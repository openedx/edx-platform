...
class TestProgramsApiConfig(ProgramsApiConfigMixin, TestCase):
    ...
    def test_url_construction(self, _mock_cache):
        ...
        programs_config = self.create_program_config()
    ...
    def test_cache_control(self, cache_ttl, is_cache_enabled, _mock_cache):
        ...
        programs_config = self.create_program_config(cache_ttl=cache_ttl)
    ...
    def test_is_student_dashboard_enabled(self, _mock_cache):
        ...
        """
        programs_config = self.create_program_config(enabled=False)
        self.assertFalse(programs_config.is_student_dashboard_enabled)

        programs_config = self.create_program_config(enable_student_dashboard=False)
        self.assertFalse(programs_config.is_student_dashboard_enabled)
    ...
    def test_is_studio_tab_enabled(self, _mock_cache):
        ...
        programs_config = self.create_program_config(enable_studio_tab=False)
        self.assertFalse(programs_config.is_studio_tab_enabled)

        programs_config = self.create_program_config(authoring_app_js_path='', authoring_app_css_path='')
        self.assertFalse(programs_config.is_studio_tab_enabled)
