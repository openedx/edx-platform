...
def add_enrollment(username, course_id, mode=None, is_active=True, enrollment_attributes=None, enterprise_uuid=None, assigned_by=None):
    ...
    enrollment = _data_api().create_course_enrollment(username, course_id, mode, is_active, enterprise_uuid, assigned_by=assigned_by)
