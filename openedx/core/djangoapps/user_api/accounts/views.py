...
class AccountView(APIView):
    ...
    **Response Values for GET**
        ...
        If the user makes the request for her own account, or makes a request
        ...
        * language_proficiencies: array of language preferences. Each preference
        ...
        * "code": string ISO 639-1 language code e.g. "en".
        ...
        exactly as specified. The intention is that plain text is supported,
        not HTML.
    ...
    **Response Values for PATCH**
        ...
        a status of 403 for staff access but a 404 for ordinary users to
        avoid leaking the existence of the account.

        If no user exists with the specified username, a 404 error is returned.

        If "application/merge-patch+json" is not the specified content type, a
        ...
        update, a 400 error is returned with specific errors in the returned
        JSON collection.
