...
from third_party_auth import (
    pipeline as third_party_auth_pipeline,
    is_enabled as is_third_party_auth_enabled,
)
...
class RegistrationView(APIView):
    ...
    def _get_third_party_auth_redirect_url(self, request):
        ...
        if is_third_party_auth_enabled() and third_party_auth_pipeline.running(request):
            running_pipeline = third_party_auth_pipeline.get(request)
            return third_party_auth_pipeline.get_complete_url(running_pipeline['backend'])
