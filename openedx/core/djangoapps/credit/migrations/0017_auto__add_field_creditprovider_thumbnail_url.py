...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('credit_creditprovider', 'thumbnail_url',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('credit_creditprovider', 'thumbnail_url')
    ...
    models = {
        ...
        'credit.crediteligibility': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2016, 7, 26, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'credit.creditprovider': {
            ...
            'thumbnail_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '255'})
        },
        ...
        'credit.creditrequirement': {
            'Meta': {'ordering': "['order']", 'unique_together': "(('namespace', 'name', 'course'),)", 'object_name': 'CreditRequirement'},
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
