...
def course_info_to_ccxcon(course_key):
    ...
    oauth_ccxcon = get_oauth_client(
        server_token_url=urllib.parse.urljoin(course.ccx_connector, CCXCON_TOKEN_URL),
    ...
    add_course_url = urllib.parse.urljoin(course.ccx_connector, CCXCON_COURSEXS_URL)
