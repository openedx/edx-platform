...
from lms.djangoapps.courseware.toggles import (
    ...
    courseware_mfe_exit_page_is_active,
...
class CoursewareMeta:
    ...
    @property
    def can_view_legacy_courseware(self):
        return courseware_legacy_is_visible(
            self.course_key,
    ...
    def is_microfrontend_enabled_for_user(self):
        """
        Can the user stay in the microfrontend experience?
        """
    ...
    def course_exit_page_is_active(self):
        ...
        return courseware_mfe_exit_page_is_active(self.course_key)
