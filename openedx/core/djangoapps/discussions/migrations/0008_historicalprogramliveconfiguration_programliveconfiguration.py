    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=True, help_text='If disabled, the live lti in the associated program will be disabled.')),
                ('provider_type', models.CharField(help_text="The lti provider's id", max_length=50, verbose_name='Live lti provider')),
