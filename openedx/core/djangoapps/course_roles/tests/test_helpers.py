...
from openedx.core.djangoapps.course_roles.data import CourseRolesPermission, PermissionData
...
class PermissionCheckTestCase(SharedModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.course_2_id = CourseKey.from_string(str(self.course_2.id))
        ...
        permission_1_data = PermissionData("test_permission_1", "test_permission_1", "test_permission_1")
        permission_1 = Permission.objects.create(name=permission_1_data.name)
        self.mock_permission_1 = mock.Mock(spec=CourseRolesPermission)
        self.mock_permission_1.value = permission_1_data
        self.role_1.permissions.add(permission_1)
        self.role_2 = Role.objects.create(name="test_role_3")
        self.role_2.services.add(self.service)
        self.role_2.permissions.add(permission_1)
        permission_2_data = PermissionData("test_permission_2", "test_permission_2", "test_permission_2")
        self.permission_2 = Permission.objects.create(name=permission_2_data.name)
        self.mock_permission_2 = mock.Mock(spec=CourseRolesPermission)
        self.mock_permission_2.value = permission_2_data
    ...
    def test_user_has_permission_course_with_anonymus_user(self):
        ...
        """
        assert not user_has_permission_course(self.anonymous_user, self.mock_permission_1, self.course_1_key)
    ...
    def test_user_has_permission_course_with_course_level_permission(self):
        ...
        assert user_has_permission_course(self.user_1, self.mock_permission_1, self.course_1_key)
    ...
    def test_user_has_permission_course_without_course_level_permission(self):
        ...
        course level
        """
        assert not user_has_permission_course(self.user_1, self.mock_permission_1, self.course_1_key)
    ...
    def test_user_has_permission_org_with_anonymous_user(self):
        ...
        """
        assert not user_has_permission_org(self.anonymous_user, self.mock_permission_1, self.organization_1.name)
    ...
    def test_user_has_permission_org_with_organization_level_permission(self):
        ...
        """
        UserRole.objects.create(user=self.user_1, role=self.role_1, org=self.organization_1)
        assert user_has_permission_org(self.user_1, self.mock_permission_1, self.organization_1.name)
    ...
    def test_user_has_permission_org_without_organization_level_permission(self):
        ...
        """
        assert not user_has_permission_org(self.user_1, self.mock_permission_1, self.organization_1.name)
    ...
    def test_user_has_permission_list_course_with_anonymous_user(self):
        ...
        """
        assert not user_has_permission_list_course(self.anonymous_user, [self.mock_permission_1], self.course_1_key)
    ...
    def test_user_has_permission_list_course_with_course_level_permission(self):
        ...
        """
        UserRole.objects.create(
            user=self.user_1, role=self.role_2, course_id=self.course_1_key, org=self.organization_1
        )
        test_permissions = [self.mock_permission_1, self.mock_permission_2]
        assert user_has_permission_list_course(self.user_1, test_permissions, self.course_1_key)
    ...
    def test_user_has_permission_list_course_without_course_level_permission(self):
        ...
        test_permissions = [self.mock_permission_1, self.mock_permission_2]
        assert not user_has_permission_list_course(self.user_1, test_permissions, self.course_1_key)
    ...
    def test_user_has_permission_list_org_with_anonymous_user(self):
        ...
        assert not user_has_permission_list_org(
            self.anonymous_user, [self.mock_permission_1], self.organization_1.name
        )
    ...
    def test_course_permission_list_check_any_with_a_permission_in_the_course(self):
        ...
        UserRole.objects.create(
            user=self.user_1,
            role=self.role_1,
            course_id=self.course_1_key,
            org=self.organization_1
        )
        test_permissions = [self.mock_permission_1, self.mock_permission_2]
        assert user_has_permission_list_any_course(self.user_1, test_permissions, self.course_1_key)
    ...
    def test_course_permission_list_check_any_with_no_permission_in_the_course(self):
        ...
        """
        test_permissions = [self.mock_permission_1, self.mock_permission_2]
        assert not user_has_permission_list_any_course(self.user_1, test_permissions, self.course_1_key)
    ...
    def test_course_permission_list_check_any_with_a_permission_in_a_different_course(self):
        ...
        test_permissions = [self.mock_permission_2]
        assert not user_has_permission_list_any_course(self.user_1, test_permissions, self.course_1_key)
    ...
    def test_user_has_permission_course_org_with_anonymous_user(self):
        ...
        assert not user_has_permission_course_org(
            self.anonymous_user, self.mock_permission_1, self.course_1_key
        )
    ...
    def test_user_has_permission_course_org_with_course_level_permission(self):
        ...
        assert user_has_permission_course_org(
            self.user_1, self.mock_permission_1, self.course_1_key
        )
...
class GetAllUserPermissionsTestcase(SharedModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.permission_3 = Permission.objects.create(name="test_permission_3")
        self.permission_4 = Permission.objects.create(name="test_permission_4")
        self.permission_5 = Permission.objects.create(name="test_permission_5")
    ...
    def test_get_all_user_permissions_for_a_course(self):
        ...
        assert get_all_user_permissions_for_a_course(self.user_1.id, self.course_1_key) == {self.permission_1.name}
        UserRole.objects.create(
    ...
    def test_get_all_user_permissions_for_a_course_with_no_permissions(self):
        ...
        """
        assert not get_all_user_permissions_for_a_course(self.user_1.id, self.course_1_key)
    ...
    def test_get_all_user_permissions_for_a_course_with_invalid_user(self):
        ...
        """
        with pytest.raises(ValueError):
            get_all_user_permissions_for_a_course(999, self.course_1_key)
    ...
    def test_get_all_user_permissions_for_a_course_with_invalid_course(self):
        ...
        """
        with pytest.raises(ValueError):
            get_all_user_permissions_for_a_course(self.user_1.id, CourseKey.from_string("course-v1:org+course+run"))
