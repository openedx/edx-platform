...
# TODO EVENT BUS:
# Use TrackingEvent class from openedx_events and use Attr <-> Abro bridge to deserialize
class TrackingEvent:
    """
    Copy of TrackingEvent from license-manager to represent license manager events
    """
...
## TODO EVENT BUS: Make an extensible base class for message handlers
