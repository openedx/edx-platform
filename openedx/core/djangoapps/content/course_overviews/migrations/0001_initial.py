...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_overviews_courseoverviewdescriptor', (
            ...
            ('enrollment_start', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('enrollment_end', self.gf('django.db.models.fields.DateTimeField')(null=True)),
            ('start', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2029, 12, 31, 0, 0), null=True)),
    ...
    models = {
        'course_overviews.courseoverviewdescriptor': {
            ...
            'start': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2029, 12, 31, 0, 0)', 'null': 'True'}),
