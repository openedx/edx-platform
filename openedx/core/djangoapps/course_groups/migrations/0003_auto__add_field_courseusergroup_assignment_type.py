...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseUserGroup.assignment_type'
        db.add_column('course_groups_courseusergroup', 'assignment_type',
                      self.gf('django.db.models.fields.CharField')(default='manual', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseUserGroup.assignment_type'
        db.delete_column('course_groups_courseusergroup', 'assignment_type')
    ...
    models = {
        ...
        'course_groups.courseusergroup': {
            ...
            'assignment_type': ('django.db.models.fields.CharField', [], {'default': "'manual'", 'max_length': '6'}),
