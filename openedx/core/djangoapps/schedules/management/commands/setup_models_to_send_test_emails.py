...
class ThreeDayNudgeSchedule(ScheduleFactory):
    ...
    """
    start_date = factory.Faker('date_time_between', start_date='-3d', end_date='-3d', tzinfo=get_utc_timezone())
...
class TenDayNudgeSchedule(ScheduleFactory):
    ...
    """
    start_date = factory.Faker('date_time_between', start_date='-10d', end_date='-10d', tzinfo=get_utc_timezone())
...
class UpgradeReminderSchedule(ScheduleFactory):
    ...
    """
    start_date = factory.Faker('past_datetime', tzinfo=get_utc_timezone())
    upgrade_deadline = factory.Faker('date_time_between', start_date='+2d', end_date='+2d', tzinfo=get_utc_timezone())
...
class ContentHighlightSchedule(ScheduleFactory):
    ...
    """
    start_date = factory.Faker('date_time_between', start_date='-7d', end_date='-7d', tzinfo=get_utc_timezone())
