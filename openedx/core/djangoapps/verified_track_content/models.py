        ...
        if not is_course_cohorted(course_key):
            ...
            if any(cohort.name == verified_cohort_name for cohort in existing_manual_cohorts):
                ...
                log.info(
                    ...
                    "due to change in enrollment mode from '%s' to '%s'.",  # pylint: disable=unicode-format-string
                ...
                log.error(
                    ...
                    "but verified cohort named '%s' does not exist.",  # pylint: disable=unicode-format-string
                    course_key,
