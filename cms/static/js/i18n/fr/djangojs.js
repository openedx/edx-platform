...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "If the course does not have an end date, learners always see their scores when they submit answers to assessments.": "Si la sous-section n'a aucune date d'\u00e9ch\u00e9ance, les \u00e9tudiants pourront toujours voir leurs notes apr\u00e8s avoir donn\u00e9 leurs r\u00e9ponses lors de l'\u00e9valuation.",
    ...
    "Learners do not see whether their answers to assessments were correct or incorrect, nor the score received, until after the course end date has passed.": "Avant la date d'\u00e9ch\u00e9ance de cette sous-section, les \u00e9tudiants ne peuvent ni voir leur r\u00e9sultat aux \u00e9valuations ni conna\u00eetre leur note.",
    ...
    "No results found for \"%(query_string)s\". Please try searching again.": "Aucun r\u00e9sultat trouv\u00e9 pour \"%(query_string)s\". Veuillez r\u00e9essayer.",
    ...
    "Once your account is deleted, you cannot use it to take courses on this site.": "Une fois votre compte supprim\u00e9, vous ne pouvez plus l'utiliser pour suivredes cours sur ce site.",
    ...
    "You have selected \u201cDelete my account.\u201d Deletion of your account and personal data is permanent and cannot be undone. We will not be able to recover your account or the data that is deleted.": "Vous avez s\u00e9lectionn\u00e9 \u00ab Supprimer mon compte \u00bb. La suppression d'un compte et des donn\u00e9es personnelles est permanente et ne peut \u00eatre annul\u00e9e. Nous ne pourrons pas r\u00e9cup\u00e9rer votre compte ou les donn\u00e9es supprim\u00e9es",
    ...
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email on this site.{strongEnd}": "{strongStart}Avertissement : la suppression du compte est permanente. {strongEnd}Veuillez lire attentivement les informations ci-dessus avant de poursuivre. Ceci est une action irr\u00e9versible et {strongStart}vous ne pourrez plus utiliser la m\u00eame adresse courriel sur site.{strongEnd}",
    ...
    "{strongStart}Warning: Account deletion is permanent.{strongEnd} Please read the above carefully before proceeding. This is an irreversible action, and {strongStart}you will no longer be able to use the same email this site.{strongEnd}": "{strongStart}Avertissement : la suppression du compte est permanente. {strongEnd}Veuillez lire attentivement les informations ci-dessus avant de poursuivre. Ceci est une action irr\u00e9versible et {strongStart}vous ne pourrez plus utiliser la m\u00eame adresse courriel sur site.{strongEnd}",
    "{team_count} Team": [
      "{team_count} \u00c9quipe",
      "{team_count} \u00c9quipes"
    ],
