define([
    'js/views/baseview',
    'underscore',
    'text!templates/social-sharing-selector.underscore'
], function(BaseView, _, socialSharingSelectorTemplate) {
    ...
    var SocialSharingView = BaseView.extend({
        events: {
        ...
        render: function() {
            edx.HtmlUtils.setHtml(this.$el, edx.HtmlUtils.template(socialSharingSelectorTemplate)({
