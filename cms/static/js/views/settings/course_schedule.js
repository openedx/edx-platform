define(["js/views/validation", "codemirror", "underscore", "jquery", "jquery.ui", "js/utils/date_utils",
    "js/models/uploads", "js/views/uploads", "js/utils/change_on_enter", "js/views/license", "js/models/license",
    ...
    var ScheduleView = ValidatingView.extend({
      ...
      render: function () {
        ...
        if (this.model.get('entrance_exam_enabled') === 'true') {
          this.$('#' + this.fieldToSelectorMap.entrance_exam_enabled).attr(
            'checked', this.model.get('entrance_exam_enabled')
          );
        ...
        this.$('#' + this.fieldToSelectorMap.entrance_exam_minimum_score_pct).val(
          this.model.get('entrance_exam_minimum_score_pct')
        );
