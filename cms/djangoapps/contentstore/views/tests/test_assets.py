...
class AssetToJsonTestCase(AssetsTestCase):
    ...
    def test_basic(self):
        ...
        self.assertEqual(output["external_url"], "lms_base_url/asset-v1:org+class+run+type@asset+block@my_file_name.jpg")
...
class LockAssetTestCase(AssetsTestCase):
    ...
    def test_locking(self):
        ...
        def post_asset_update(lock, course):
            ...
            url = reverse_course_url('assets_handler', course.id, kwargs={'asset_key_string': str(asset_location)})
...
class DeleteAssetTestCase(AssetsTestCase):
    ...
    def test_delete_asset_with_invalid_asset(self):
        """ Tests the sad path :( """
        test_url = reverse_course_url(
            'assets_handler', self.course.id, kwargs={'asset_key_string': str("/c4x/edX/toy/asset/invalid.pdf")})
        resp = self.client.delete(test_url, HTTP_ACCEPT="application/json")
        self.assertEqual(resp.status_code, 404)
