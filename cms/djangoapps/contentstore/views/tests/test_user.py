...
class UsersTestCase(CourseTestCase):
    ...
    def test_detail_post(self):
        ...
        self.assertFalse(auth.has_role(ext_user, CourseStaffRole(self.course.id)))
        self.assertFalse(auth.has_role(ext_user, CourseInstructorRole(self.course.id)))
    ...
    def test_detail_post_staff(self):
        ...
        # reload user from DB
        ext_user = User.objects.get(email=self.ext_user.email)
        self.assertTrue(auth.has_role(ext_user, CourseStaffRole(self.course.id)))
        self.assertFalse(auth.has_role(ext_user, CourseInstructorRole(self.course.id)))
    ...
    def test_detail_post_staff_other_inst(self):
        ...
        self.assertTrue(auth.has_role(user, CourseInstructorRole(self.course.id)))
    ...
    def test_detail_post_instructor(self):
        ...
        # reload user from DB
        ext_user = User.objects.get(email=self.ext_user.email)
        self.assertTrue(auth.has_role(ext_user, CourseInstructorRole(self.course.id)))
    ...
    def test_staff_can_delete_self(self):
        ...
        # reload user from DB
        user = User.objects.get(email=self.user.email)
        self.assertFalse(auth.has_role(user, CourseStaffRole(self.course.id)))
