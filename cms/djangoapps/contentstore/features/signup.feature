...
Feature: CMS.Sign in
  ...
  Scenario: Login with a valid redirect
    ...
    And I visit the url "/course/MITx/999/Robot_Super_Course"
    And I should see that the path is "/signin?next=/course/MITx/999/Robot_Super_Course"
    When I fill in and submit the signin form
    And I wait for "2" seconds
    Then I should see that the path is "/course/MITx/999/Robot_Super_Course"
