...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('contentstore_managementcommand', (
            ...
            ('short_desc', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('desc', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('contentstore', ['ManagementCommand'])


    def backwards(self, orm):
        # Deleting model 'ManagementCommand'
        db.delete_table('contentstore_managementcommand')
    ...
    models = {
        ...
        'contentstore.videouploadconfig': {
            'Meta': {'ordering': "('-change_date',)", 'object_name': 'VideoUploadConfig'},
            'change_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'changed_by': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
