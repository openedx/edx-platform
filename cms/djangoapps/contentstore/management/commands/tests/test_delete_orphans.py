...
class TestDeleteOrphan(TestOrphanBase):
    ...
    def test_delete_orphans_published_branch_split(self):
        ...
        """
        course, published_branch, orphan = self.create_split_course_with_published_orphan()

        number_of_items_in_published = len(self.store.get_items(published_branch))
        number_of_items_in_draft_preferred = len(self.store.get_items(course.id))
    ...
    def create_split_course_with_published_orphan(self):
        ...
        return course, published_branch, orphan
