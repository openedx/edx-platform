...
class DeleteItem(CourseTestCase):
    def setUp(self):
        ...
        self.course = CourseFactory.create(
            org='mitX', number='333', display_name='Dummy Course')
    ...
    def testDeleteStaticPage(self):
        ...
        # Now delete it. There was a bug that the delete was failing (static
        # tabs do not exist in draft modulestore).
        resp = self.client.post(reverse(
            'delete_item'), resp.content, "application/json")
        self.assertEqual(resp.status_code, 200)
