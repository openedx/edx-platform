...
class CourseTestCase(ModuleStoreTestCase):
    ...
    def assertCoursesEqual(self, course1_id, course2_id):
        ...
        for course1_item in course1_items:
            ...
            if course1_item.location.category == 'course':
                ...
                store = self.store._get_modulestore_for_courseid(course2_id)
    ...
    def assertAssetsEqual(self, asset_son, course1_id, course2_id):
        ...
        content_store = contentstore()
        course1_asset_attrs = content_store.get_attrs(course1_id.make_asset_key(asset_son['category'], asset_son['name']))
        course2_asset_attrs = content_store.get_attrs(course2_id.make_asset_key(asset_son['category'], asset_son['name']))
