...
class XBlockVisibilityTestCase(SharedModuleStoreTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.past = datetime(1970, 1, 1, tzinfo=get_utc_timezone())
        cls.future = datetime.now(get_utc_timezone()) + timedelta(days=1)
...
class ReleaseDateSourceTest(CourseTestCase):
    ...
    def setUp(self):
        ...
        self.date_one = datetime(1980, 1, 1, tzinfo=get_utc_timezone())
        self.date_two = datetime(2020, 1, 1, tzinfo=get_utc_timezone())
