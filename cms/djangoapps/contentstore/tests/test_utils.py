...
class XBlockVisibilityTestCase(SharedModuleStoreTestCase):
    ...
    def test_draft_released_xblock(self):
        ...
        self.assertTrue(utils.is_currently_visible_to_students(self.course, vertical))
    ...
    def _test_visible_to_students(self, expected_visible_without_lock, name, start_date, publish=False):
        ...
        self.assertEqual(
            ...
            utils.is_currently_visible_to_students(self.course, no_staff_lock)
        )
        ...
        self.assertFalse(utils.is_currently_visible_to_students(self.course, staff_lock))
