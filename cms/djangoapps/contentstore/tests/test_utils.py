...
class GroupVisibility(CourseTestCase):

    def setUp(self):
        super(GroupVisibility, self).setUp()
    ...
    def verify_all_components_visible_to_all(self):
        ...
        self.assertFalse(utils.has_children_visible_to_specific_content_groups(self.vertical))
        ...
        self.assertFalse(utils.is_visible_to_specific_content_groups(self.sequential))
        ...
        self.assertFalse(utils.is_visible_to_specific_content_groups(self.problem))

    def test_no_visibility_set(self):
        """ Tests when group_access has not been set on anything. """
        self.verify_all_components_visible_to_all()
