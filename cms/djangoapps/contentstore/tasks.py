    ...
    try:
        ...
        if is_course:
            if courselike_module.entrance_exam_enabled:
                ...
                from cms.djangoapps.contentstore.views.entrance_exam import remove_entrance_exam_milestone_reference
    ...
    try:
        ...
        if self.status.state == u'Updating' and is_course:
            ...
            if course.entrance_exam_enabled:
                ...
                from cms.djangoapps.contentstore.views.entrance_exam import add_entrance_exam_milestone
