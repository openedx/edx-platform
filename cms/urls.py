...
from cms.djangoapps.contentstore.views.import_export import custom_course_templates
...
urlpatterns += [
    ...
    re_path(fr'^custom_course_templates/{settings.COURSE_KEY_PATTERN}?$', custom_course_templates, name='custom_course_templates'),
