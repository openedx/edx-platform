...
urlpatterns += patterns(
    ...
    url(r'^settings/schedule/{}$'.format(settings.COURSE_KEY_PATTERN), 'settings_schedule_handler'),
    url(r'^settings/details/{}$'.format(settings.COURSE_KEY_PATTERN), 'settings_details_handler'),
