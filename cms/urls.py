...
urlpatterns = [
    ...
    url(r'^toggle_discussion_enabled/{}?$'.format(settings.COURSE_KEY_PATTERN.replace("course_key_string", "key_string")), contentstore.views.toggle_discussion_enabled, name='toggle_discussion_enabled'),
    url(r'^toggle_discussion_enabled/{}?$'.format(settings.USAGE_KEY_PATTERN.replace("usage_key_string", "key_string")), contentstore.views.toggle_discussion_enabled, name='toggle_discussion_enabled'),
