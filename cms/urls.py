...
urlpatterns = [
    ...
    url(r'^course/archive/{}?$'.format(settings.COURSE_KEY_PATTERN), contentstore_views.course_archive_handler, name='course_archive_handler'),
    url(r'^course/unarchive/{}?$'.format(settings.COURSE_KEY_PATTERN), contentstore_views.course_unarchive_handler, name='course_unarchive_handler'),
