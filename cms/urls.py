...
urlpatterns += patterns(
    ...
    url(r'^course/(?P<course_key_string>[^/]+)/coupons$', 'coupon_handler', name='coupon_handler'),
    url(r'^course/(?P<course_key_string>[^/]+)/add_coupon', 'add_coupon_handler', name='add_coupon_handler'),
    #url(r'^course/remove_coupon/$', 'remove_coupon', name='remove_coupon'),
    url(r'^remove_coupon$', 'remove_coupon'),
