...
from lms.envs.common import (
    ...
    PROGRESS_DETACHED_VERTICAL_CATEGORIES, PROGRESS_DETACHED_CATEGORIES,
    ORGANIZATION_LOGO_IMAGE_BACKEND, ORGANIZATION_LOGO_IMAGE_SIZES_MAP, ORGANIZATION_LOGO_IMAGE_SECRET_KEY,
    ORGANIZATION_LOGO_IMAGE_DEFAULT_FILENAME, ORGANIZATION_LOGO_IMAGE_DEFAULT_FILE_EXTENSION,
