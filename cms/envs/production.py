...
DATA_DIR = path(_YAML_TOKENS.get('DATA_DIR', DATA_DIR))
EMAIL_FILE_PATH = _YAML_TOKENS.get('EMAIL_FILE_PATH', DATA_DIR / "emails" / "studio")


# CMS_BASE: Public domain name of Studio (should be resolvable from the end-user's browser)
CMS_BASE = _YAML_TOKENS.get('CMS_BASE')
LMS_BASE = _YAML_TOKENS.get('LMS_BASE')
LMS_ROOT_URL = _YAML_TOKENS.get('LMS_ROOT_URL')
CMS_ROOT_URL = _YAML_TOKENS.get('CMS_ROOT_URL')
LMS_INTERNAL_ROOT_URL = _YAML_TOKENS.get('LMS_INTERNAL_ROOT_URL', LMS_ROOT_URL)
ENTERPRISE_API_URL = _YAML_TOKENS.get('ENTERPRISE_API_URL', LMS_INTERNAL_ROOT_URL + '/enterprise/api/v1/')
ENTERPRISE_CONSENT_API_URL = _YAML_TOKENS.get('ENTERPRISE_CONSENT_API_URL', LMS_INTERNAL_ROOT_URL + '/consent/api/v1/')
AUTHORING_API_URL = _YAML_TOKENS.get('AUTHORING_API_URL', '')
# Note that FEATURES['PREVIEW_LMS_BASE'] gets read in from the environment file.

CHAT_COMPLETION_API = _YAML_TOKENS.get('CHAT_COMPLETION_API', '')
CHAT_COMPLETION_API_KEY = _YAML_TOKENS.get('CHAT_COMPLETION_API_KEY', '')
LEARNER_ENGAGEMENT_PROMPT_FOR_ACTIVE_CONTRACT = _YAML_TOKENS.get('LEARNER_ENGAGEMENT_PROMPT_FOR_ACTIVE_CONTRACT', '')
LEARNER_ENGAGEMENT_PROMPT_FOR_NON_ACTIVE_CONTRACT = _YAML_TOKENS.get(
    'LEARNER_ENGAGEMENT_PROMPT_FOR_NON_ACTIVE_CONTRACT',
    ''
)
LEARNER_PROGRESS_PROMPT_FOR_ACTIVE_CONTRACT = _YAML_TOKENS.get('LEARNER_PROGRESS_PROMPT_FOR_ACTIVE_CONTRACT', '')
LEARNER_PROGRESS_PROMPT_FOR_NON_ACTIVE_CONTRACT = _YAML_TOKENS.get('LEARNER_PROGRESS_PROMPT_FOR_NON_ACTIVE_CONTRACT', '')
...
IDA_LOGOUT_URI_LIST = _YAML_TOKENS.get('IDA_LOGOUT_URI_LIST', [])

SITE_NAME = _YAML_TOKENS.get('SITE_NAME', SITE_NAME)
