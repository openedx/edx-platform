...
CELERY_BROKER_HEARTBEAT = ENV_TOKENS.get('CELERY_BROKER_HEARTBEAT', 60.0)
CELERY_BROKER_HEARTBEAT_CHECKRATE = ENV_TOKENS.get('CELERY_BROKER_HEARTBEAT_CHECKRATE', 2)
...
# Celery Broker
CELERY_TASK_ALWAYS_EAGER = ENV_TOKENS.get("CELERY_TASK_ALWAYS_EAGER", False)
...
ENV_CELERY_TASK_QUEUES = ENV_TOKENS.get('CELERY_TASK_QUEUES', None)
