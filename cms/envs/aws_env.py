...
for override, value in MONGO_OVERRIDES.iteritems():
    if value:
        CONTENTSTORE['DOC_STORE_CONFIG'][override] = value # 16
        CONTENTSTORE['OPTIONS'][override] = value # 26
        DOC_STORE_CONFIG[override] = value # 26
        MODULESTORE['default']['DOC_STORE_CONFIG'][override] = value
        MODULESTORE['default']['OPTIONS'][override] = value
        MODULESTORE['direct']['DOC_STORE_CONFIG'][override] = value
        MODULESTORE['direct']['OPTIONS'][override] = value
