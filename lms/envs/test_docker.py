...
# NOTE: Importing devstack_docker MUST come first!
...
# NOTE: This is needed because xmodule/xmodule/modulestore/tests/mongo_connection.py pulls from environment variables!
os.environ['EDXAPP_TEST_MONGO_HOST'] = 'edx.devstack.mongo'
...
CONTENTSTORE['DOC_STORE_CONFIG']['db'] = 'test_xcontent_{}'.format(THIS_UUID)
...
# with association {HMAC-SHA1}{51d49995}{s/kRmA==}
