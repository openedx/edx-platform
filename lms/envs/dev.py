...
# course data directories are still in use. Note that since this only happens in
# dev, the js files must be present in the course directories in prod, (i.e. you
# must commit them).
