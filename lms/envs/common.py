...
# .. toggle_implementation: DjangoSetting
# .. toggle_default: None
# .. toggle_description: List of lists, with inner list of format ['lms.module.dotted.path', 'owning-team'] (e.g. [['student', 'team-red']]).  Used to set monitoring custom metrics for owner.
