...
# Support legacy Zendesk settings
ZENDESK_URL = ENV_TOKENS.get("ZENDESK_URL", '')
HELPDESK = ENV_TOKENS.get("HELPDESK", 'Zendesk' if ZENDESK_URL else '')
HELPDESK_URL = ENV_TOKENS.get("HELPDESK_URL", ZENDESK_URL)
...
# Helpdesk
HELPDESK_USER = AUTH_TOKENS.get("HELPDESK_USER", ZENDESK_USER)
HELPDESK_API_KEY = AUTH_TOKENS.get("HELPDESK_API_KEY", ZENDESK_API_KEY)
