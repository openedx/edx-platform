...
##### JOURNALS CONFIGURATION SETTINGS #####
JOURNALS_URL_ROOT = ENV_TOKENS.get('JOURNALS_URL_ROOT', JOURNALS_URL_ROOT)
JOURNALS_API_URL = ENV_TOKENS.get('JOURNALS_API_URL', JOURNALS_API_URL)
