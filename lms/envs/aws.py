...
if ENV_TOKENS.get('CLEAR_SESSIONS_PERIOD_HOURS', 24) is not None:
    CELERYBEAT_SCHEDULE['run_clearsesions'] = {
        'task': 'util.tasks.run_clearsessions',
        'schedule': datetime.timedelta(hours=ENV_TOKENS.get('CLEAR_SESSIONS_PERIOD_HOURS', 24)),
    }
