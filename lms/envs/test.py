...
PROFILE_IMAGE_BACKEND_CONFIG = {
    'storage_class': 'storages.backends.overwrite.OverwriteStorage',
    'storage_kwargs': {
        'location': '/edx/var/edxapp/uploads/profile_images/',
        'base_url': 'http://example-storage.com/profile_images/',
    },
}
