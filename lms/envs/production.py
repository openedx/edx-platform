...
def _generate_public_enrollment_api_url(settings):
    return (settings.LMS_ROOT_URL or '') + settings.LMS_ENROLLMENT_API_PATH
ENTERPRISE_PUBLIC_ENROLLMENT_API_URL = _generate_public_enrollment_api_url


# Enrollment URL used on the server-side.
def _generate_enterprise_enrollment_api_url(settings):
    return (settings.LMS_INTERNAL_ROOT_URL or '') + settings.LMS_ENROLLMENT_API_PATH
ENTERPRISE_ENROLLMENT_API_URL = _generate_enterprise_enrollment_api_url
