...
ANALYTICS_API_URL = AUTH_TOKENS.get("ANALYTICS_API_URL", ANALYTICS_API_URL)

# Mailchimp New User List
MAILCHIMP_NEW_USER_LIST_ID = ENV_TOKENS.get("MAILCHIMP_NEW_USER_LIST_ID")

# Zendesk
ZENDESK_USER = ENV_TOKENS.get("ZENDESK_USER")
ZENDESK_API_KEY = ENV_TOKENS.get("ZENDESK_API_KEY")
