...
$(function () {
  ...
  d3.json("${reverse('all_sequential_open_distrib', kwargs=dict(course_id=unicode(course_id)))}", function(error, json) {
  ...
  d3.json("${reverse('all_problem_grade_distribution', kwargs=dict(course_id=unicode(course_id)))}", function(error, json) {
