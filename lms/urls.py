...
urlpatterns = [
    ...
    path('course_modes/', include('common.djangoapps.course_modes.urls'),
    ),
    path('api/course_modes/', include(
...
urlpatterns += [
    ...
    path('reset_deadlines', util_views.reset_course_deadlines,
    ...
    path('courses/yt_video_metadata', courseware_views.yt_video_metadata,
    ...
    # Student Notes API
    path('api/edxnotes/v1/', include('lms.djangoapps.edxnotes.api_urls'),
    ),
    ...
    # Learner profile
    path('u/', include('openedx.features.learner_profile.urls'),
    ),
]
...
if settings.FEATURES.get('ENABLE_INSTRUCTOR_BACKGROUND_TASKS'):
    urlpatterns += [
        path('instructor_task_status/', instructor_task_views.instructor_task_status,
...
if settings.FEATURES.get('ENABLE_OAUTH2_PROVIDER'):
    urlpatterns += [
        path('oauth2/login/', LoginWithAccessTokenView.as_view(),
...
if settings.FEATURES.get('ENABLE_FINANCIAL_ASSISTANCE_FORM'):
    urlpatterns += [
        path('financial-assistance/', courseware_views.financial_assistance,
            name='financial_assistance'
        ),
        path('financial-assistance/apply/', courseware_views.financial_assistance_form,
            name='financial_assistance_form'
        ),
        path('financial-assistance/submit/', courseware_views.financial_assistance_request,
...
if getattr(settings, 'PROVIDER_STATES_URL', None):
    ...
    urlpatterns += [
        path('courses/xblock/handler/provider_states', courseware_xblock_handler_provider_state,
