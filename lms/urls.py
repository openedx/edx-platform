...
from lms.djangoapps.instructor.views.coupons import remove_coupon, add_coupon, update_coupon, get_coupon_info
...
from course_wiki.views import root_create, course_wiki_redirect
...
from staticbook.views import (
    index as staticbook_index,
    pdf_index as staticbook_pdf_index,
    html_index as staticbook_html_index,
)
from notes.views import notes
from notification_prefs.views import ajax_enable, ajax_disable, ajax_status, set_subscription
...
# FIXME! CAS is old and needs to be updated for this
# from django_cas.views import logout as cas_logout
from lms_migration.migrate import manage_modulestores, gitreload
...
from certificates.views import update_certificate, update_example_certificate, request_certificate
