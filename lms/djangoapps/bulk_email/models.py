...
class CourseEmail(Email):
    ...
    def get_template(self):
        ...
        """
        return CourseEmailTemplate.get_template(name='default')
...
class CourseEmailTemplate(models.Model):
    ...
    def get_template(name=None):
        ...
        """
        log.warning("buscando %s" % name)
        try:
            return CourseEmailTemplate.objects.get(name='default')
        except CourseEmailTemplate.DoesNotExist:
            log.exception("Attempting to fetch a non-existent course email template %s " %name)
            raise
