...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEmail.fake_field'
        db.add_column('bulk_email_courseemail', 'fake_field',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=24, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEmail.fake_field'
        db.delete_column('bulk_email_courseemail', 'fake_field')
    ...
    models = {
        ...
        'bulk_email.courseemail': {
            ...
            'fake_field': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '24', 'blank': 'True'}),
