...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEmail.location'
        db.add_column('bulk_email_courseemail', 'location',
                      self.gf('django.db.models.fields.CharField')(db_index=True, max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CourseEmail.to_list'
        db.add_column('bulk_email_courseemail', 'to_list',
                      self.gf('bulk_email.fields.SeparatedValuesField')(null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEmail.location'
        db.delete_column('bulk_email_courseemail', 'location')

        # Deleting field 'CourseEmail.to_list'
        db.delete_column('bulk_email_courseemail', 'to_list')
    ...
    models = {
        ...
        'bulk_email.courseemail': {
            ...
            'to_list': ('bulk_email.fields.SeparatedValuesField', [], {'null': 'True'}),
