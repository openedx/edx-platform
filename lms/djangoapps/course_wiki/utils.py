...
def user_is_article_course_staff(user, article):
    ...
    the same course wiki root e.g. edX/Phy101/Spring and HarvardX/Phy101/Fall
    will share /Phy101.
    ...
    staff on course edX/Phy101/Spring they will be in
    'instructor_edX/Phy101/Spring' or 'staff_edX/Phy101/Spring' groups and
