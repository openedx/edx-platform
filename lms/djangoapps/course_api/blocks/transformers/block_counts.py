    ...
    def transform(self, usage_info, block_structure):
        ...
        for block_key in block_structure.post_order_traversal():
            for block_type in self.block_types_to_count:
                descendants_type_count = sum(block_structure.get_transformer_block_field(child_key, self, block_type, 0) for child_key in block_structure.get_children(block_key))
