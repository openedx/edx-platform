...
class AnonymousIndexPageTest(ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.course = CourseFactory.create(
            ...
            enrollment_start=datetime.datetime.now(get_utc_timezone()) + datetime.timedelta(days=3),
...
class IndexPageCourseCardsSortingTests(ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        self.starting_later = CourseFactory.create(
            ...
            metadata={
                'start': datetime.datetime.now(get_utc_timezone()) + datetime.timedelta(days=4),
                'announcement': datetime.datetime.now(get_utc_timezone()) + datetime.timedelta(days=3),
            },
            emit_signals=True,
        )
        self.starting_earlier = CourseFactory.create(
            ...
            metadata={
                'start': datetime.datetime.now(get_utc_timezone()) + datetime.timedelta(days=2),
                'announcement': datetime.datetime.now(get_utc_timezone()) + datetime.timedelta(days=1),
            },
            emit_signals=True,
        )
