...
def get_course_with_access(user, action, course_key, depth=0, check_if_enrolled=False, check_survey_complete=True, check_if_authenticated=False, allow_not_started_courses=False):  # lint-amnesty, pylint: disable=line-too-long
    """
    ...
    check_course_access_with_redirect(course, user, action, check_if_enrolled, check_survey_complete, check_if_authenticated, allow_not_started_courses=allow_not_started_courses)  # lint-amnesty, pylint: disable=line-too-long
    return course
...
def check_course_access_with_redirect(course, user, action, check_if_enrolled=False, check_survey_complete=True, check_if_authenticated=False, allow_not_started_courses=False):  # lint-amnesty, pylint: disable=line-too-long
    """
    Check that the user has the access to perform the specified action
    on the course (CourseBlock|CourseOverview).
