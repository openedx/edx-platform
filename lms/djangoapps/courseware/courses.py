...
from dateutil.parser import parse as parse_date  # lint-amnesty, pylint: disable=import-error
...
from fs.errors import ResourceNotFound  # lint-amnesty, pylint: disable=import-error
