...
def get_redirect_url(course_key, usage_key, first_child=False):
    ...
    Args:
        ...
        first_child(bool): Indicates whether the first child should be accessed
