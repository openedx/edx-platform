...
class AnnotatableSteps(object):
    ...
    def click_reply(self, step, problem):
        ...
        annotations = world.css_find('.annotatable-reply[data-problem-id="{}"]'.format(problem))
        assert_equals(len(annotations), 1)
        annotations[0].click()
    ...
    def check_scroll_to_problem(self, step):
        ...
        annotation_input = world.css_find(annotation_input_selector).first
        assert_true(annotation_input.visible)
    ...
    def check_scroll_to_annotatable(self, step):
        ...
        assert_true(world.css_find('.annotation-header').first.visible)
