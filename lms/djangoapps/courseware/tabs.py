...
from xmodule.tabs import CourseTab, CourseTabList, course_reverse_func_from_name_func, key_checker  # lint-amnesty, pylint: disable=import-error, wrong-import-order
...
class CourseInfoTab(CourseTab):
    ...
    @classmethod
    def is_enabled(cls, course, user=None):  # lint-amnesty, pylint: disable=unused-argument
        return True
