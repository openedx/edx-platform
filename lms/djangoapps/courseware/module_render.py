...
def toc_for_course(user, request, course, active_chapter, active_section, field_data_cache):
    ...
    with modulestore().bulk_operations(course.id):
        ...
        for chapter in chapters:
            ...
            display_id = slugify(chapter.display_name_w_default_escaped)
            ...
            for section in chapter.get_display_items():
                ...
                if not section.hide_from_toc:
                    section_context = {
                        'display_name': section.display_name_w_default_escaped,
            ...
            toc_chapters.append({
                'display_name': chapter.display_name_w_default_escaped,
...
def get_module_by_usage_id(request, course_id, usage_id, disable_staff_debug_info=False, course=None):
    ...
    tracking_context = {
        'module': {
            'display_name': descriptor.display_name_w_default_escaped,
