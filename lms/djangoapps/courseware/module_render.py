...
def get_module_system_for_user(user, field_data_cache,
    ...
    def rebind_noauth_module_to_user(module, real_user):
        ...
        if getattr(module, '_bound_student', None) == real_user:
            return
        ...
        module._bound_student = real_user
...
def get_module_for_descriptor_internal(user, descriptor, field_data_cache, course_id,  # pylint: disable=invalid-name
    ...
    if getattr(descriptor, '_bound_student', None) == user:
        return descriptor
    ...
    descriptor._bound_student = user
    return descriptor
