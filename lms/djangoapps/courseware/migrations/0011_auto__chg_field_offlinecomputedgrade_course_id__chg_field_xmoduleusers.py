...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'XModuleUserStateSummaryField.usage_id'
        db.alter_column('courseware_xmoduleuserstatesummaryfield', 'usage_id', self.gf('xmodule_django.models.LocationKeyField')(max_length=255))

        # Changing field 'StudentModule.module_state_key'
        db.alter_column('courseware_studentmodule', 'module_id', self.gf('xmodule_django.models.LocationKeyField')(max_length=255, db_column='module_id'))

        # Changing field 'StudentModule.course_id'
        db.alter_column('courseware_studentmodule', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255))

        # Changing field 'OfflineComputedGradeLog.course_id'
        db.alter_column('courseware_offlinecomputedgradelog', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'XModuleUserStateSummaryField.usage_id'
        db.alter_column('courseware_xmoduleuserstatesummaryfield', 'usage_id', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'StudentModule.module_state_key'
        db.alter_column('courseware_studentmodule', 'module_id', self.gf('django.db.models.fields.CharField')(max_length=255, db_column='module_id'))

        # Changing field 'StudentModule.course_id'
        db.alter_column('courseware_studentmodule', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=255))

        # Changing field 'OfflineComputedGradeLog.course_id'
        db.alter_column('courseware_offlinecomputedgradelog', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=255))
