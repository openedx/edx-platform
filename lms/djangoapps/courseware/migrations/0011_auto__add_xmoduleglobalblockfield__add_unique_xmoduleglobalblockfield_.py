...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'XModuleGlobalBlockField'
        db.create_table('courseware_xmoduleglobalblockfield', (
        ...
        db.send_create_signal('courseware', ['XModuleGlobalBlockField'])

        # Adding unique constraint on 'XModuleGlobalBlockField', fields ['module_type', 'field_name']
        db.create_unique('courseware_xmoduleglobalblockfield', ['module_type', 'field_name'])
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'XModuleGlobalBlockField', fields ['module_type', 'field_name']
        db.delete_unique('courseware_xmoduleglobalblockfield', ['module_type', 'field_name'])

        # Deleting model 'XModuleGlobalBlockField'
        db.delete_table('courseware_xmoduleglobalblockfield')
    ...
    models = {
        ...
        'courseware.xmoduleglobalblockfield': {
            'Meta': {'unique_together': "(('module_type', 'field_name'),)", 'object_name': 'XModuleGlobalBlockField'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'db_index': 'True', 'blank': 'True'}),
