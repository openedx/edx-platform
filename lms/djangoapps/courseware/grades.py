...
def answer_distributions(course_key):
    ...
    def url_and_display_name(usage_key):
        ...
        if usage_key not in state_keys_to_problem_info:
            ...
            problem_info = (problem.url_name, problem.display_name_w_default_escaped)
...
def _grade(student, request, course, keep_raw_scores, field_data_cache, scores_client):
    ...
    for section_format, sections in grading_context['graded_sections'].iteritems():
        ...
        for section in sections:
            ...
            section_name = section_descriptor.display_name_w_default_escaped
                    ...
                    for module_descriptor in descendants:
                        ...
                        scores.append(
                            Score(
                                ...
                                total,
                                graded,
                                module_descriptor.display_name_w_default_escaped,
...
def _progress_summary(student, request, course, field_data_cache=None, scores_client=None):
    ...
    for chapter_module in course_module.get_display_items():
        ...
        for section_module in chapter_module.get_display_items():
            ...
            with outer_atomic():
                ...
                section_total, _ = graders.aggregate_scores(
                    scores, section_module.display_name_w_default_escaped)

                module_format = section_module.format if section_module.format is not None else ''
                sections.append({
                    'display_name': section_module.display_name_w_default_escaped,
        ...
        chapters.append({
            'course': course.display_name_w_default_escaped,
            'display_name': chapter_module.display_name_w_default_escaped,
