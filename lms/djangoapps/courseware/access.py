...
from genplus.lms.djangoapps.genplus_learning.cache import ProgramCache
...
def admin_access_to_course_for_user(user, course_key):
    ...
    if program:
        from genplus.lms.djangoapps.genplus_learning.access import administrative_accesses_to_program_for_user
