...
class TestGetHtmlMethod(BaseTestXmodule):
    ...
    def test_get_html_source(self):
        ...
        cases = [
            # self.download_video == True
            {
                ...
                """,
                'result': {
                    'download_video_link': 'example_source.mp4',
                    'sources': ['example.mp4', 'example.webm'],
                },
            },
            {
    ...
    def test_get_html_with_existing_edx_video_id(self):
        ...
        data = {
            ...
            'edx_video_id': edx_video_id,
            'result': {
                'download_video_link': 'http://fake-video.edx.org/{}.mp4'.format(edx_video_id),
    ...
    def encode_and_create_video(self, edx_video_id):
        ...
        for profile, extension in [("desktop_webm", "webm"), ("desktop_mp4", "mp4")]:
            ...
            encoded_videos.append(
                dict(
                    url="http://fake-video.edx.org/{}.{}".format(edx_video_id, extension),
                    file_size=9000,
                    bitrate=42,
                    profile=profile,
                )
