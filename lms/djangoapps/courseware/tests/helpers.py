...
from xmodule.modulestore.tests.django_utils import TEST_DATA_MONGO_MODULESTORE, ModuleStoreTestCase  # lint-amnesty, pylint: disable=import-error, wrong-import-order
...
from xmodule.tests import get_test_descriptor_system, get_test_system  # lint-amnesty, pylint: disable=import-error, wrong-import-order
