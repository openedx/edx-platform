...
class TestAnonymousStudentId(SharedModuleStoreTestCase, LoginEnrollmentTestCase):
    ...
    def test_per_course_anonymized_id(self, descriptor_class):
        self.assertEquals(
            ...
            self._get_anonymous_id(CourseLocator('MITx', '6.00x', '2012_Fall'), descriptor_class)
        )
        ...
        self.assertEquals(
            ...
            self._get_anonymous_id(CourseLocator('MITx', '6.00x', '2013_Spring'), descriptor_class)
        )
