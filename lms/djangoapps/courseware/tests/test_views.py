...
from edx_toggles.toggles.testutils import override_waffle_flag, override_waffle_switch  # lint-amnesty, pylint: disable=import-error
from markupsafe import escape
from milestones.tests.utils import MilestonesTestCaseMixin  # lint-amnesty, pylint: disable=import-error
from mock import MagicMock, PropertyMock, call, create_autospec, patch  # lint-amnesty, pylint: disable=import-error
...
from xblock.fields import Scope, String  # lint-amnesty, pylint: disable=import-error

import lms.djangoapps.courseware.views.views as views
from capa.tests.response_xml_factory import MultipleChoiceResponseXMLFactory  # lint-amnesty, pylint: disable=import-error, wrong-import-order
...
from xmodule.course_module import COURSE_VISIBILITY_PRIVATE, COURSE_VISIBILITY_PUBLIC, COURSE_VISIBILITY_PUBLIC_OUTLINE  # lint-amnesty, pylint: disable=import-error, wrong-import-order
from xmodule.graders import ShowCorrectness  # lint-amnesty, pylint: disable=import-error, wrong-import-order
...
class IndexQueryTestCase(ModuleStoreTestCase):
    ...
    def test_index_query_counts(self, store_type, expected_mongo_query_count, expected_mysql_query_count):
        ...
        self.user = UserFactory()  # lint-amnesty, pylint: disable=attribute-defined-outside-init
