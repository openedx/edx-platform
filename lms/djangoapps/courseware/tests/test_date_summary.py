...
class CourseDateSummaryTest(SharedModuleStoreTestCase):
    ...
    @ddt.data(
        ...
        (False, datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')), datetime(2025, 1, 12, tzinfo=ZoneInfo('UTC')),
            datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')), 'Course starts'),

        # Self-paced course: Enrollment created later than course start
        (True, datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')), datetime(2025, 1, 12), datetime(2025, 1, 12, tzinfo=ZoneInfo('UTC')),
            'Enrollment Date'),

        # Self-paced course: Enrollment created earlier than course start
        (True, datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')), datetime(2025, 1, 8), datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')),
            'Course starts'),

        # Self-paced course: No enrollment
        (True, datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')), None, datetime(2025, 1, 10, tzinfo=ZoneInfo('UTC')), 'Course starts'),
    )
    @ddt.unpack
