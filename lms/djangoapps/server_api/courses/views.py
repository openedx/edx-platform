...
from server_api.courses.courseware_access import get_course, get_course_child, get_course_descriptor
from server_api.views import APIViewWithPermissions, PaginatedListAPIViewWithPermissions, PermissionMixin
from server_api.courses.serializers import CourseSerializer, AssignmentSerializer, GradingPolicySerializer
...
def _serialize_content(request, course_key, content_descriptor):
    ...
    # Other things we do only if the content object is not a course
        ...
        content_uri = request.build_absolute_uri(reverse('server_api:courses:content:detail',
...
class CourseGradingPolicy(PermissionMixin, generics.ListAPIView):
    ...
    **Example requests**:
        ...
        GET /api/courses/{course_id}/grading_policy/
