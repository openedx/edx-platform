...
urlpatterns = patterns(
    ...
    url(
        r'^{}/all_sequential_open_distrib$'.format(settings.COURSE_ID_PATTERN),
        'class_dashboard.views.all_sequential_open_distrib',
        name='all_sequential_open_distrib',
    ),

    url(
        r'^{}/all_problem_grade_distribution$'.format(settings.COURSE_ID_PATTERN),
        'class_dashboard.views.all_problem_grade_distribution',
        name='all_problem_grade_distribution',
    ),

    # Json request data for metrics for particular section
    url(
        r'^{}/problem_grade_distribution/(?P<section>\d+)$'.format(settings.COURSE_ID_PATTERN),
        'class_dashboard.views.section_problem_grade_distrib',
        name='section_problem_grade_distrib',
    ),
    ...
    url(
        ...
        name='get_students_opened_subsection',
    ),
    ...
    url(
        ...
        name='get_students_problem_grades',
    ),
