...
INVALID_USER_PARTITION_VALIDATION = _(u"This component refers to deleted or invalid user partitions.")
INVALID_USER_PARTITION_GROUP_VALIDATION = _(u"This component refers to deleted or invalid user partition groups.")
