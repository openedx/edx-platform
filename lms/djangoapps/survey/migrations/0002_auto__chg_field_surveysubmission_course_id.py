...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('survey_surveysubmission', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'SurveySubmission.course_id'
        db.alter_column('survey_surveysubmission', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=128))
