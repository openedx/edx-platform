...
from static_template_view.views import index, render, render_404, render_500, render_press_release
...
urlpatterns = [
    ...
    url(r'^404$', render_404, name="render_404"),  # Can this be deleted? Test test_404_microsites fails with this.
    url(r'^500$', render_500, name="render_500"),
...
for key, value in settings.MKTG_URL_LINK_MAP.items():
    ...
    urlpatterns += [
        url(r'^%s$' % key.lower(), render, {'template': template}, name=value),
    ]
