...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        parser.add_argument('--key', action='store', help='mailchimp api key', required=True)
        parser.add_argument('--list', action='store', dest='list_id', help='mailchimp list id', required=True, type=int)
        parser.add_argument('--course', action='store', dest='course_id', help='xmodule course_id', required=True)
