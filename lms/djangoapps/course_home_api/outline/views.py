...
from lms.djangoapps.course_home_api.tasks import calculate_course_progress_for_user_in_course
    ...
    **Returns**
    ...
    def get(self, request, *args, **kwargs):  # pylint: disable=too-many-statements
        ...
        if send_course_progress_analytics_for_student_is_enabled(course_key) and not user_is_masquerading:
            calculate_course_progress_for_user_in_course.delay(course_key_string, request.user.id)
