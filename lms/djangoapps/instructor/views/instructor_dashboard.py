...
def instructor_dashboard_2(request, course_id):
    ...
    if settings.FEATURES.get("ENABLE_CANVAS_INTEGRATION", True):
...
def _section_canvas_integration(course):
    ...
    return {
        ...
        'course': course,
        'add_enrollments_using_canvas_url': reverse(
            'add_enrollments_using_canvas', kwargs={'course_id': course.id}
        ),
    }
