...
class TestInstructorAPIDenyLevels(SharedModuleStoreTestCase, LoginEnrollmentTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.chapter = BlockFactory.create(
            ...
            publish_item=True,
            start=datetime.datetime(2018, 3, 10, tzinfo=get_utc_timezone()),
        )
...
class TestInstructorSendEmail(SiteMixin, SharedModuleStoreTestCase, LoginEnrollmentTestCase):
    ...
    def test_send_email_with_schedule(self, mock_task_api):
        ...
        expected_schedule = dateutil.parser.parse(schedule).replace(tzinfo=get_utc_timezone())
...
class TestDueDateExtensions(SharedModuleStoreTestCase, LoginEnrollmentTestCase):
    ...
    def setUpClass(cls):
        super().setUpClass()
        cls.course = CourseFactory.create()
        cls.due = datetime.datetime(2010, 5, 12, 2, 42, tzinfo=get_utc_timezone())
    ...
    def test_change_due_date(self):
        ...
        due_date = datetime.datetime(2013, 12, 30, tzinfo=get_utc_timezone())
        response = self.client.post(url, {
    ...
    def test_reset_date_only_in_edx_when(self):
        ...
        original_due = datetime.datetime(2010, 4, 1, tzinfo=get_utc_timezone())
        ...
        override = datetime.datetime(2010, 7, 1, tzinfo=get_utc_timezone())
...
class TestDueDateExtensionsDeletedDate(ModuleStoreTestCase, LoginEnrollmentTestCase):
    ...
    def setUp(self):
        ...
        self.due = datetime.datetime(2010, 5, 12, 2, 42, tzinfo=get_utc_timezone())
    ...
    def test_reset_extension_to_deleted_date(self):
        ...
        assert response.status_code == 200, response.content
        assert datetime.datetime(2013, 12, 30, 0, 0, tzinfo=get_utc_timezone()) ==\
