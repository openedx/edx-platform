...
class TestInstructorDashboard(ModuleStoreTestCase, LoginEnrollmentTestCase, XssTestMixin):
    ...
    def test_open_response_assessment_page(self):
        ...
        """
        ora_section = '<li class="nav-item"><button type="button" class="btn-link" data-section="open_response_assessment">Open Responses</button></li>'  # pylint: disable=line-too-long
