...
def instructor_dashboard(request, course_id):
    ...
    if action == 'Dump list of enrolled students' or action == 'List enrolled students':
        ...
        if student is not None:
            ...
            track.views.server_track(request, "get-student-progress-page", {"student": str(student), "instructor": str(request.user), "course": course_id}, page="idashboard")
    ...
    # Admin
        ...
        if user is not None:
            ...
            track.views.server_track(request, "add-instructor", {"instructor": str(user)}, page="idashboard")
        ...
        if user is not None:
            ...
            track.views.server_track(request, "remove-instructor", {"instructor": str(user)}, page="idashboard")
    ...
    # psychometrics
        ...
        msg += nmsg
        track.views.server_track(request, "psychometrics-histogram-generation", {"problem": str(problem)}, page="idashboard")
...
def _add_or_remove_user_group(request, username_or_email, group, group_title, event_name, do_add):
    ...
    if user is not None:
        ...
        track.views.server_track(request, "add-or-remove-user-group", {"event_name": event_name, "user": str(user), "event": event}, page="idashboard")
