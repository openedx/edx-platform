...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'InstructorTask.course_id'
        db.alter_column('instructor_task_instructortask', 'course_id', self.gf('xmodule_django.models.CourseKeyField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'InstructorTask.course_id'
        db.alter_column('instructor_task_instructortask', 'course_id', self.gf('django.db.models.fields.CharField')(max_length=255))
