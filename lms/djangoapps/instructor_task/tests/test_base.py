...
class TestReportMixin(object):
    ...
    def verify_rows_in_csv(self, expected_rows, verify_order=False):
        """
        ...
        Arguments:
            ...
            verify_order (boolean): When True, we verify that both the content
                and order of `expected_rows` matches the actual csv rows.
                When False (default), we only verify that the content matches.
        """
