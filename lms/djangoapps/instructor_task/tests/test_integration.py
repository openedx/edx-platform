...
from xblock_capa.lib.responsetypes import StudentInputError
from xblock_capa.tests.response_xml_factory import CodeResponseXMLFactory, CustomResponseXMLFactory
...
class TestRescoringTask(TestIntegrationTask):
    ...
    def test_rescoring_failure(self):
        ...
        with patch('xblock_capa.capa_problem.LoncapaProblem.get_grade_from_current_answers') as mock_rescore:
