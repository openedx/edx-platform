...
class SupportViewEnrollmentsTests(SharedModuleStoreTestCase, SupportViewTestCase):
    ...
    def setUp(self):
        ...
        self.verification_deadline = VerificationDeadline(
            ...
            deadline=datetime.now(get_utc_timezone()) + timedelta(days=365)
        )
    ...
    def set_course_end_date_and_expiry(self):
        ...
        self.course.start = datetime(year=1970, month=1, day=1, tzinfo=get_utc_timezone())
        self.course.end = datetime(year=1970, month=1, day=10, tzinfo=get_utc_timezone())
        ...
        verified_mode.expiration_datetime = datetime(year=1970, month=1, day=9, tzinfo=get_utc_timezone())
        verified_mode.save()
...
class ResetCourseViewTestBase(SupportViewTestCase):
    ...
    def setUp(self):
        ...
        super().setUp()
        SupportStaffRole().add_users(self.user)
        self.now = datetime.now().replace(tzinfo=get_utc_timezone())
        self.course = CourseFactory.create(
