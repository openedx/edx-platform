...
const fetchEntitlementsFailure = error => dispatch => dispatch(displayError('Error Getting Entitlements', error));

const emptyEntitlementsFailure = error => dispatch => dispatch(displayError('No Entitlements Found', error));

const fetchEntitlements = username => (dispatch) => {
...
const reissueEntitlementFailure = error => dispatch => dispatch(displayError('Error Reissuing Entitlement', error));

const reissueEntitlement = ({ entitlement, comments }) => (dispatch) => {
    patchEntitlement({
