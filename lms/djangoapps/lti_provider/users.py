...
def get_lti_user_details(request):
    ...
    """
    email = request.POST.get("lis_person_contact_email_primary", "").lower()
    full_name = request.POST.get("lis_person_name_full", "")
    given_name = request.POST.get("lis_person_name_given", "")
