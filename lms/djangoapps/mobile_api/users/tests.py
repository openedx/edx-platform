...
class TestUserEnrollmentApi(UrlResetMixin, MobileAPITestCase, MobileAuthUserTestMixin,
    ...
    NEXT_WEEK = datetime.datetime.now(get_utc_timezone()) + datetime.timedelta(days=7)
    LAST_WEEK = datetime.datetime.now(get_utc_timezone()) - datetime.timedelta(days=7)
...
class TestUserEnrollmentsStatus(MobileAPITestCase, MobileAuthUserTestMixin):
    ...
    def test_user_have_active_and_inactive_enrollments_and_no_completions(self) -> None:
        ...
        old_enrollment.created = datetime.datetime.now(get_utc_timezone()) - datetime.timedelta(days=31)
        old_enrollment.save()
    ...
    def test_different_enrollment_dates(self, enrolled_days_ago: int, recently_active_status: bool) -> None:
        ...
        enrollment.created = datetime.datetime.now(get_utc_timezone()) - datetime.timedelta(days=enrolled_days_ago)
        enrollment.save()
    ...
    def test_different_completion_dates(self, completed_days_ago: int, recently_active_status: bool) -> None:
        ...
        enrollment.created = datetime.datetime.now(get_utc_timezone()) - datetime.timedelta(days=50)
        enrollment.save()
        ...
        completion.created = datetime.datetime.now(get_utc_timezone()) - datetime.timedelta(days=completed_days_ago)
        completion.save()
