...
class TestAppVersionConfigModel(TestCase):
    ...
    @ddt.data(
        ('ios', '3.3.3', datetime(9000, 1, 1, tzinfo=get_utc_timezone())),
        ('ios', '4.4.4', datetime(9000, 1, 1, tzinfo=get_utc_timezone())),
        ('ios', '6.6.6', None),
        ("android", '4.4.4', datetime(9000, 1, 1, tzinfo=get_utc_timezone())),
        ('android', '8.8.8', None)
    )
    @ddt.unpack
