...
class TestAppVersionUpgradeMiddleware(CacheIsolationTestCase):
    ...
    def set_app_version_config(self):
        ...
        AppVersionConfig(
            platform="iOS",
            version="2.2.2",
            expire_at=datetime(2014, 1, 1, tzinfo=get_utc_timezone()),
            enabled=True
        ).save()
        AppVersionConfig(
            platform="iOS",
            version="4.4.4",
            expire_at=datetime(9000, 1, 1, tzinfo=get_utc_timezone()),
            enabled=True
        ).save()
        ...
        AppVersionConfig(
            platform="Android",
            version="4.4.4",
            expire_at=datetime(5000, 1, 1, tzinfo=get_utc_timezone()),
            enabled=True
        ).save()
