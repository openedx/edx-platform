...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PDFCertificateConfiguration'
        db.create_table('certificates_pdfcertificateconfiguration', (
            ...
            ('long_org', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('long_course', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('version', self.gf('django.db.models.fields.SmallIntegerField')(default=1, null=True, blank=True)),
            ('render_course_name', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('render_attr_phrase', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('create_verification_page', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('course_association_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('xseries_num_courses', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('is_active', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('certificates', ['PDFCertificateConfiguration'])


    def backwards(self, orm):
        # Deleting model 'PDFCertificateConfiguration'
        db.delete_table('certificates_pdfcertificateconfiguration')
    ...
    models = {
        ...
        'certificates.examplecertificate': {
            ...
            'access_key': ('django.db.models.fields.CharField', [], {'default': "'a181785c5f7a441091316c4e0b8d79b4'", 'max_length': '255', 'db_index': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "'fd79508c36e949788ccdf132b7646780'", 'unique': 'True', 'max_length': '255', 'db_index': 'True'})
        },
        ...
        'certificates.pdfcertificateconfiguration': {
            'Meta': {'object_name': 'PDFCertificateConfiguration'},
            'course_association_text': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'course_key': ('xmodule_django.models.CourseKeyField', [], {'max_length': '255', 'db_index': 'True'}),
            'create_verification_page': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'created': ('model_utils.fields.AutoCreatedField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'long_course': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'long_org': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'}),
            'render_attr_phrase': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'render_course_name': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'version': ('django.db.models.fields.SmallIntegerField', [], {'default': '1', 'null': 'True', 'blank': 'True'}),
            'xseries_num_courses': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
