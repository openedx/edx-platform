...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CouponRedemption.Coupon'
        db.delete_column('shoppingcart_couponredemption', 'Coupon_id')

        # Adding field 'CouponRedemption.coupon'
        db.add_column('shoppingcart_couponredemption', 'coupon',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['shoppingcart.Coupons']),
                      keep_default=False)
