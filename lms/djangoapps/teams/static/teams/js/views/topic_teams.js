(function(define) {
    ...
    define([
        ...
        var TopicTeamsView = TeamsView.extend({
            ...
            canUserCreateTeamErrorMessage: gettext(
            ...
            canUserCreateTeam: function() {
                ...
                if (this.context.userInfo.staff || this.context.userInfo.privileged) {
                    ...
                    $.ajax({
                        ...
                        TeamUtils.parseAndShowMessage(data, self.canUserCreateTeamErrorMessage);
                        deferred.resolve(false);
                    });
                }
            ...
            render: function() {
                ...
                this.collection.refresh().done(function() {
                    ...
                    self.canUserCreateTeam().done(function(canUserCreateTeam) {
