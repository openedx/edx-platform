...
class TopicSerializerTestCase(SerializerTestCase):
    ...
    def test_topic_with_no_team_count(self):
        ...
        with self.assertNumQueries(1):
            ...
            self.assertEqual(
                serializer.data,
                {'name': 'Tøpic', 'description': 'The bést topic!', 'id': '0', 'team_count': 0}
            )
    ...
    def test_topic_with_team_count(self):
        ...
        with self.assertNumQueries(1):
            ...
            self.assertEqual(
                serializer.data,
                {'name': 'Tøpic', 'description': 'The bést topic!', 'id': '0', 'team_count': 1}
            )
...
class BaseTopicSerializerTestCase(SerializerTestCase):
    ...
    def setup_topics(self, num_topics=5, teams_per_topic=0):
        ...
        topics = [
            {'name': 'Tøpic {}'.format(i), 'description': 'The bést topic! {}'.format(i), 'id': str(i)}
