...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseTeam.discussion_id'
        db.add_column('teams_courseteam', 'discussion_id',
                      self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseTeam.discussion_id'
        db.delete_column('teams_courseteam', 'discussion_id')
    ...
    models = {
        ...
        'teams.courseteam': {
            ...
            'discussion_id': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '255'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
