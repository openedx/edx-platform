...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        modified_start = datetime.strptime(options['modified_start'], DATE_FORMAT).replace(tzinfo=get_utc_timezone())
        modified_end = datetime.strptime(options['modified_end'], DATE_FORMAT).replace(tzinfo=get_utc_timezone())
