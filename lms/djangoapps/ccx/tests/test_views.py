...
class TestCCXProgressChanges(CcxTestCase, LoginEnrollmentTestCase):
    ...
    def setUpClass(cls):
        ...
        """
        super().setUpClass()
        start = datetime.datetime(2016, 7, 1, 0, 0, tzinfo=get_utc_timezone())
        due = datetime.datetime(2016, 7, 8, 0, 0, tzinfo=get_utc_timezone())
...
class TestCoachDashboard(CcxTestCase, LoginEnrollmentTestCase):
    ...
    def test_edit_schedule(self, today):
        ...
        Get CCX schedule, modify it, save it.
        """
        today.return_value = datetime.datetime(2014, 11, 25, tzinfo=get_utc_timezone())
        self.make_coach()
        ccx = self.make_ccx()
        url = reverse(
            'ccx_coach_dashboard',
