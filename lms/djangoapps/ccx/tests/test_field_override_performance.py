...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        #     # of mongo queries,
        # )
        ('no_overrides', 1, True, False): (17, 1),
        ('no_overrides', 2, True, False): (17, 1),
        ('no_overrides', 3, True, False): (17, 1),
        ('ccx', 1, True, False): (17, 1),
        ('ccx', 2, True, False): (17, 1),
        ('ccx', 3, True, False): (17, 1),
        ('no_overrides', 1, False, False): (17, 1),
        ('no_overrides', 2, False, False): (17, 1),
        ('no_overrides', 3, False, False): (17, 1),
        ('ccx', 1, False, False): (17, 1),
        ('ccx', 2, False, False): (17, 1),
        ('ccx', 3, False, False): (17, 1),
    }
