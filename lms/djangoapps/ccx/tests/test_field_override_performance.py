...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (25, 6, 13),
        ('no_overrides', 2, True, False): (70, 6, 84),
        ('no_overrides', 3, True, False): (265, 6, 335),
        ('ccx', 1, True, False): (25, 6, 13),
        ('ccx', 2, True, False): (70, 6, 84),
        ('ccx', 3, True, False): (265, 6, 335),
        ('ccx', 1, True, True): (25, 6, 13),
        ('ccx', 2, True, True): (70, 6, 84),
        ('ccx', 3, True, True): (265, 6, 335),
        ('no_overrides', 1, False, False): (25, 6, 13),
        ('no_overrides', 2, False, False): (70, 6, 84),
        ('no_overrides', 3, False, False): (265, 6, 335),
        ('ccx', 1, False, False): (25, 6, 13),
        ('ccx', 2, False, False): (70, 6, 84),
        ('ccx', 3, False, False): (265, 6, 335),
        ('ccx', 1, False, True): (25, 6, 13),
        ('ccx', 2, False, True): (70, 6, 84),
        ('ccx', 3, False, True): (265, 6, 335),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (25, 4, 9),
        ('no_overrides', 2, True, False): (70, 19, 54),
        ('no_overrides', 3, True, False): (265, 84, 215),
        ('ccx', 1, True, False): (25, 4, 9),
        ('ccx', 2, True, False): (70, 19, 54),
        ('ccx', 3, True, False): (265, 84, 215),
        ('ccx', 1, True, True): (27, 4, 13),
        ('ccx', 2, True, True): (72, 19, 84),
        ('ccx', 3, True, True): (267, 84, 335),
        ('no_overrides', 1, False, False): (25, 4, 9),
        ('no_overrides', 2, False, False): (70, 19, 54),
        ('no_overrides', 3, False, False): (265, 84, 215),
        ('ccx', 1, False, False): (25, 4, 9),
        ('ccx', 2, False, False): (70, 19, 54),
        ('ccx', 3, False, False): (265, 84, 215),
