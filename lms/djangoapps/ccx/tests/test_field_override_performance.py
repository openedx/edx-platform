...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 2, True, False): (135, 7, 85),
        ('no_overrides', 3, True, False): (595, 7, 336),
        ('ccx', 1, True, False): (27, 7, 14),
        ('ccx', 2, True, False): (135, 7, 85),
        ('ccx', 3, True, False): (595, 7, 336),
        ('ccx', 1, True, True): (27, 7, 14),
        ('ccx', 2, True, True): (135, 7, 85),
        ('ccx', 3, True, True): (595, 7, 336),
        ('no_overrides', 1, False, False): (27, 7, 14),
        ('no_overrides', 2, False, False): (135, 7, 85),
        ('no_overrides', 3, False, False): (595, 7, 336),
        ('ccx', 1, False, False): (27, 7, 14),
        ('ccx', 2, False, False): (135, 7, 85),
        ('ccx', 3, False, False): (595, 7, 336),
        ('ccx', 1, False, True): (27, 7, 14),
        ('ccx', 2, False, True): (135, 7, 85),
        ('ccx', 3, False, True): (595, 7, 336),
    }
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 3, True, False): (595, 84, 215),
        ('ccx', 1, True, False): (27, 4, 9),
        ('ccx', 2, True, False): (135, 19, 54),
        ('ccx', 3, True, False): (595, 84, 215),
        ('ccx', 1, True, True): (36, 4, 13),
        ('ccx', 2, True, True): (186, 19, 84),
        ('ccx', 3, True, True): (802, 84, 335),
        ('no_overrides', 1, False, False): (27, 4, 9),
        ('no_overrides', 2, False, False): (135, 19, 54),
        ('no_overrides', 3, False, False): (595, 84, 215),
        ('ccx', 1, False, False): (27, 4, 9),
        ('ccx', 2, False, False): (135, 19, 54),
        ('ccx', 3, False, False): (595, 84, 215),
        ('ccx', 1, False, True): (27, 4, 9),
        ('ccx', 2, False, True): (135, 19, 54),
        ('ccx', 3, False, True): (595, 84, 215),
    }
