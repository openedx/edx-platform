...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        #     # of mongo queries,
        # )
        ('no_overrides', 1, True, False): (23, 6),
        ('no_overrides', 2, True, False): (23, 6),
        ('no_overrides', 3, True, False): (23, 6),
        ('ccx', 1, True, False): (23, 6),
        ('ccx', 2, True, False): (23, 6),
        ('ccx', 3, True, False): (23, 6),
        ('no_overrides', 1, False, False): (23, 6),
        ('no_overrides', 2, False, False): (23, 6),
        ('no_overrides', 3, False, False): (23, 6),
        ('ccx', 1, False, False): (23, 6),
        ('ccx', 2, False, False): (23, 6),
        ('ccx', 3, False, False): (23, 6),
    }
