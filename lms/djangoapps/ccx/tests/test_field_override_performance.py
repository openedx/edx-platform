...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('ccx', 1, True, True): (23, 3), ##('ccx', 1, True, True): (24, 3) maybe ('ccx', 1, True, True): (23, 3),
        ('ccx', 2, True, True): (23, 3), ##('ccx', 1, True, True): (24, 3) maybe ('ccx', 1, True, True): (23, 3),
        ('ccx', 3, True, True): (23, 3), ##('ccx', 1, True, True): (24, 3) maybe ('ccx', 1, True, True): (23, 3),
