...
from opaque_keys.edx.locator import BlockUsageLocator, CourseLocator  # lint-amnesty, pylint: disable=import-error

from xmodule.modulestore import XMODULE_FIELDS_WITH_USAGE_KEYS  # lint-amnesty, pylint: disable=import-error
