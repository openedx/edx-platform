...
from common.djangoapps.django_comment_common.models import FORUM_ROLE_ADMINISTRATOR, FORUM_ROLE_MODERATOR, \
    FORUM_ROLE_COMMUNITY_TA, FORUM_ROLE_STUDENT
from common.djangoapps.django_comment_common.utils import STUDENT_ROLE_PERMISSIONS,  MODERATOR_ROLE_PERMISSIONS, \
