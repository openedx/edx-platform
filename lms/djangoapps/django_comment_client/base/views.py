    ...
    def wrapper(request, *args, **kwargs):
        ...
        def fetch_content():
            ...
            if "thread_id" in kwargs:
                ...
                content = None
            return content
        course_key = course_key_from_string_or_404(kwargs['course_id'])
...
def create_comment(request, course_id, thread_id):
    ...
    return _create_comment(request, course_key_from_string_or_404(course_id), thread_id=thread_id)
...
def create_sub_comment(request, course_id, comment_id):
    ...
    if is_comment_too_deep(parent=cc.Comment(comment_id)):
        return JsonError(_("Comment level too deep"))
    return _create_comment(request, course_key_from_string_or_404(course_id), parent_id=comment_id)
