...
class EdxNotesHelpersTest(ModuleStoreTestCase):
            ...
            [
                {
                    ...
                    u"text": u"text",
                    u"chapter": {
                        u"display_name": self.chapter.display_name_w_default_escaped,
                        u"index": 0,
                        u"location": unicode(self.chapter.location),
                        u"children": [unicode(self.sequential.location)]
                    },
                    u"section": {
                        u"display_name": self.sequential.display_name_w_default_escaped,
                    ...
                    u"unit": {
                        ...
                        u"display_name": self.vertical.display_name_w_default_escaped,
    ...
    def test_get_module_context_html_component(self):
        ...
        self.assertDictEqual(
            {
                u"display_name": self.html_module_1.display_name_w_default_escaped,
    ...
    def test_get_module_context_chapter(self):
        ...
        self.assertDictEqual(
            {
                u"display_name": self.chapter_2.display_name_w_default_escaped,
                u"index": 1,
    ...
    def test_get_course_position_to_chapter(self):
        ...
        mock_chapter.display_name_w_default_escaped = 'Test Chapter Display Name'
    ...
    def test_get_course_position_to_section(self):
        ...
        mock_section.display_name_w_default_escaped = 'Test Section Display Name'
