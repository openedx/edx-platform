...
class CommentsServiceMockMixin:
    ...
    def register_get_threads_response(self, threads, page, num_pages, overrides={}):
    ...
    def register_get_threads_search_response(self, threads, rewrite, num_pages=1):
        ...
        self.mock_search_threads.return_value = {
            "collection": threads,
            "page": 1,
            "num_pages": num_pages,
    ...
    def register_post_thread_response(self, thread_data):
        """Register a mock response for the create_thread method."""
        self.mock_create_thread.return_value = thread_data
    ...
    def register_put_thread_response(self, thread_data):
        ...
        thread_id.
        """
        self.mock_update_thread.return_value = thread_data
    ...
    def register_get_thread_response(self, thread):
        ...
        self.mock_get_thread.return_value = thread
    ...
    def register_post_comment_response(self, comment_data, thread_id, parent_id=None):
        ...
        for key, val_list in comment_data.items():
            ...
            if key in ["anonymous", "anonymous_to_peers", "endorsed"]:
                ...
                response_data[key] = val
        if parent_id:
            self.mock_create_child_comment.return_value = response_data
        else:
            self.mock_create_parent_comment.return_value = response_data
    ...
    def register_put_comment_response(self, comment_data):
        ...
        for key, val_list in comment_data.items():
            ...
            if key in ["anonymous", "anonymous_to_peers", "endorsed"]:
                ...
                response_data[key] = val
        self.mock_update_comment.return_value = response_data
    ...
    def register_get_comment_error_response(self, comment_id, status_code):
        ...
        endpoint.
        """
        self.mock_get_parent_comment.side_effect = Exception("404 Not Found")
    ...
    def register_get_comment_response(self, response_overrides):
        ...
        self.mock_get_parent_comment.return_value = comment
    ...
    def register_get_username_replacement_response(self, user, status=200, body=""):
        self.mock_update_username.return_value = body
