...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Project', fields ['course_id', 'organization', 'content_id']
        db.create_unique('projects_project', ['course_id', 'organization_id', 'content_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['course_id', 'organization', 'content_id']
        db.delete_unique('projects_project', ['course_id', 'organization_id', 'content_id'])
