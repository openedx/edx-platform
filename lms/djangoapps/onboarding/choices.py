FUNCTIONS = (
    ...
    ('function_stakeholder_engagement', 'External relations and partnerships'),
...
INTERESTS = (
    ...
    ('interest_stakeholder_engagement', 'External relations and partnerships'),
...
HEAR_ABOUT_PHILANTHROPY_DICT = dict(HEAR_ABOUT_PHILANTHROPY)
