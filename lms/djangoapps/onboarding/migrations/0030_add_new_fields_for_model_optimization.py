...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='historicaluserextendedprofile',
            name='goals',
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[(b'goal_contribute_to_org', b'Help improve my organization'), (b'goal_gain_new_skill', b'Develop new skills'), (b'goal_improve_job_prospect', b'Get a job'), (b'goal_relation_with_other', b'Build relationships with other nonprofit leaders')], max_length=93, null=True),
        ),
        migrations.AddField(
            model_name='historicaluserextendedprofile',
        ...
        migrations.AddField(
            ...
            field=multiselectfield.db.fields.MultiSelectField(blank=True, choices=[(b'learners_same_region', b'Learners from my region or country'), (b'learners_similar_oe_interest', b'Learners interested in same areas of organization effectiveness'), (b'learners_similar_org', b'Learners working for similar organizations'), (b'learners_diff_who_are_different', b'Learners who are different from me')], max_length=102, null=True),
        ),
        migrations.AddField(
