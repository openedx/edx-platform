...
urlpatterns = [
    ...
    path('results_callback', views.results_callback,
        name="verify_student_results_callback",
    ),

    path('submit-photos/', views.SubmitPhotosView.as_view(),
        name="verify_student_submit_photos"
    ),

    path('status/', views.VerificationStatusAPIView.as_view(),
    ...
    path('reverify', views.ReverifyView.as_view(),
