...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalVerificationDeadline.is_override_deadline'
        db.add_column('verify_student_historicalverificationdeadline', 'is_override_deadline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'VerificationDeadline.is_override_deadline'
        db.add_column('verify_student_verificationdeadline', 'is_override_deadline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalVerificationDeadline.is_override_deadline'
        db.delete_column('verify_student_historicalverificationdeadline', 'is_override_deadline')

        # Deleting field 'VerificationDeadline.is_override_deadline'
        db.delete_column('verify_student_verificationdeadline', 'is_override_deadline')
    ...
    models = {
        ...
        'verify_student.historicalverificationdeadline': {
            ...
            'is_override_deadline': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('model_utils.fields.AutoLastModifiedField', [], {'default': 'datetime.datetime.now'})
        },
        'verify_student.icrvstatusemailsconfiguration': {
            'Meta': {'ordering': "('-change_date',)", 'object_name': 'IcrvStatusEmailsConfiguration'},
        ...
        'verify_student.softwaresecurephotoverification': {
            ...
            'receipt_id': ('django.db.models.fields.CharField', [], {'default': "'5f2c3e46-e1a1-45ef-8441-f510d4e65b66'", 'max_length': '255', 'db_index': 'True'}),
