...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoricalVerificationDeadline.deadline_is_explicit'
        db.add_column('verify_student_historicalverificationdeadline', 'deadline_is_explicit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'VerificationDeadline.deadline_is_explicit'
        db.add_column('verify_student_verificationdeadline', 'deadline_is_explicit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoricalVerificationDeadline.deadline_is_explicit'
        db.delete_column('verify_student_historicalverificationdeadline', 'deadline_is_explicit')

        # Deleting field 'VerificationDeadline.deadline_is_explicit'
        db.delete_column('verify_student_verificationdeadline', 'deadline_is_explicit')
    ...
    models = {
        ...
        'verify_student.historicalverificationdeadline': {
            ...
            'deadline_is_explicit': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'verify_student.softwaresecurephotoverification': {
            ...
            'receipt_id': ('django.db.models.fields.CharField', [], {'default': "'0f76a6e5-22cb-49f4-9e1c-80bf9197ef46'", 'max_length': '255', 'db_index': 'True'}),
