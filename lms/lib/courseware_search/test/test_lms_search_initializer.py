...
class LmsSearchInitializerTestCase(StaffMasqueradeTestCase):
    ...
    def build_course(self):
        ...
        """
        self.global_staff = UserFactory(is_staff=True)  # pylint: disable=no-member
    ...
    def setUp(self):
        ...
        modulestore().update_item(self.course, self.global_staff.id)
    ...
    def test_staff_masquerading_added_to_group(self):
        ...
        field_dictionary, filter_directory, _ = LmsSearchFilterGenerator.generate_field_filters(  # pylint: disable=unused-variable
