  ...
  @urlFor: (name, param, param1, param2) ->
    {
      ...
      search                  : "/courses/#{$$course_id}/discussion/search"
      tags_autocomplete       : "/courses/#{$$course_id}/discussion/threads/tags/autocomplete"
      retrieve_discussion     : "/courses/#{$$course_id}/discussion/#{param}/inline"
      retrieve_single_thread  : "/courses/#{$$course_id}/discussion/#{param}/#{param1}"
