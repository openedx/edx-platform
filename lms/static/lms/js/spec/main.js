...
(function(requirejs) {
    ...
    testFiles = [
        ...
        'js/programs_dashboard/spec/collection_list_view_spec.js',
        'js/programs_dashboard/spec/course_card_view_spec.js',
        'js/programs_dashboard/spec/course_enroll_view_spec.js',
        'js/programs_dashboard/spec/course_entitlement_view_spec.js',
        'js/programs_dashboard/spec/entitlement_unenrollment_view_spec.js',
        'js/programs_dashboard/spec/program_card_view_spec.js',
        'js/programs_dashboard/spec/program_details_header_spec.js',
        'js/programs_dashboard/spec/program_details_sidebar_view_spec.js',
        'js/programs_dashboard/spec/program_details_view_spec.js',
        'js/programs_dashboard/spec/progress_circle_view_spec.js',
        'js/programs_dashboard/spec/sidebar_view_spec.js',
        'js/programs_dashboard/spec/unenroll_view_spec.js',
