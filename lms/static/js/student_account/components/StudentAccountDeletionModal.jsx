              ...
              <StatusAlert
                dialog={(
                  <div className="modal-alert">
                    ...
                    <div className="alert-content">
                      <h3 className="alert-title">{ gettext('You have selected “Delete my account.” Deletion of your account and personal data is permanent and cannot be undone. UC San Diego Online will not be able to recover your account or the data that is deleted.') }</h3>
                      <p>{ gettext('If you proceed, you will be unable to use this account to access or take courses through UC San Diego Online.') }</p>
