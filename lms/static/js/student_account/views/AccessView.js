        ...
        return Backbone.View.extend({
            ...
            load: {
                login: function( data, context ) {
                    ...
                    context.subview.login =  new LoginView({
                        fields: data.fields,
                        model: model,
                ...
                reset: function( data, context ) {
                    ...
                    context.subview.passwordHelp = new PasswordResetView({
                        fields: data.fields,
                        model: model
                    });
                },
                ...
                register: function( data, context ) {
                    ...
                    context.subview.register = new RegisterView({
                        fields: data.fields,
                        model: model,
                        thirdPartyAuth: context.thirdPartyAuth,
                        platformName: context.platformName
            ...
            authComplete: function() {
                var enrollment = EnrollmentInterface,
