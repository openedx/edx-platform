                    ...
                    fields: [
                        ...
                        },
                        {
                            view: new AccountSettingsFieldViews.PasswordFieldView({
                                ...
                                helpMessage: gettext('When you click "Reset Password", a message will be sent to your email address. Click the link in the message to reset your password.')  // jshint ignore:line
                            })
                        },
                        {
                        ...
                        return {
                            'view': new AccountSettingsFieldViews.AuthFieldView({
                                ...
                                screenReaderTitle: StringUtils.interpolate(
                                    gettext('Connect your {accountName} account'),
