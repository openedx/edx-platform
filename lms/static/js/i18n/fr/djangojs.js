...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Bottom": "Bas", 
    "Browse %(sr_start)s teams %(sr_end)s": "Parcourir les %(sr_start)s \u00e9quipes %(sr_end)s", 
    ...
    "Showing %(first_index)s-%(last_index)s out of %(num_items)s total": "Affichage de %(first_index)s-%(last_index)s sur %(num_items)s total", 
    ...
    "Showing results for \"%(searchString)s\"": "Montre les r\u00e9sultats pour \"%(searchString)s\"", 
    ...
    "The team \"%(team)s\" could not be found.": "\u00c9quipe \"%(team)s\" introuvable.", 
