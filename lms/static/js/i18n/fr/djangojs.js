...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Cancel": "Annuler", 
    "Cannot drop more <% attrs.types %> than will assigned.": "Impossible de d\u00e9poser plus de <% attrs.types %> qu'il n'est possible d'en assigner.", 
    "Caption": "L\u00e9gende", 
    "Cell": "Cellule", 
    ...
    "Contains %(count)s group": [
      "Contient %(count)s groupe", 
      "Contient %(count)s groupes"
    ], 
    ...
    "Edit section release date": "Modifier la date de publication de la section", 
    ...
    "This Group Configuration is not in use. Start by adding a content experiment to any Unit via the %(outlineAnchor)s.": "Cette configuration de groupe n'est pas utilis\u00e9e. Commencez par ajouter une exp\u00e9rience de contenu \u00e0 l'une des unit\u00e9s \u00e0 l'aide de %(outlineAnchor)s.", 
    ...
    "This content group is not in use. Add a content group to any unit from the %(outlineAnchor)s.": "Ce groupe de contenu n'est pas utilis\u00e9. Vous pouvez ajouter un groupe de contenu a n'importe quelle unit\u00e9 depuis le %(outlineAnchor)s.", 
    ...
    "Used in %(count)s unit": [
      "utilis\u00e9e par %(count) unit\u00e9.", 
      "utilis\u00e9e par %(count)s unit\u00e9s."
    ], 
    "User": "Utilisateur", 
    ...
    "{month}/{day}/{year} at {hour}:{minute} UTC": "le {day}/{month}/{year} \u00e0 {hour}:{minute} UTC", 
