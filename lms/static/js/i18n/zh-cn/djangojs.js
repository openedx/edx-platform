...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "%(download_link_start)sDownload this image (right-click or option-click, save as)%(link_end)s and then %(upload_link_start)supload%(link_end)s it to your backpack.</li>": "%(download_link_start)s\u4e0b\u8f7d\u6b64\u56fe\u50cf\uff08\u53f3\u51fb\u6216\u5355\u51fb\u9009\u9879\uff0c\u53e6\u5b58\u4e3a\uff09%(link_end)s\uff0c\u968f\u540e%(upload_link_start)s\u4e0a\u4f20%(link_end)s\u81f3\u60a8\u7684 backpack \u4e2d\u3002</li>", 
    ...
    "Create Account": "\u521b\u5efa\u8d26\u53f7", 
    "Create Re-run": "\u521b\u5efa\u91cd\u542f", 
    "Create a %(link_start)sMozilla Backpack%(link_end)s account, or log in to your existing account": "\u521b\u5efa\u4e00\u4e2a%(link_start)sMozilla Backpack%(link_end)s \u8d26\u53f7\uff0c\u6216\u767b\u5f55\u60a8\u5df2\u6709\u7684\u8d26\u53f7", 
