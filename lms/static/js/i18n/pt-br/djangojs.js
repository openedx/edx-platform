...
(function (globals) {
  ...
  django.catalog = {
    ...
    "The {cohortGroupName} cohort has been created. You can manually add students to this cohort below.": "O grupo {NomeDoGrupo}  foi criado.Voc\u00ea pode adicionar manualmente os estudantes para o curso abaixo.", 
    ...
    "We've sent a confirmation message to {new_email_address}. Click the link in the message to update your email address.": "N\u00f3s enviamos uma mensagem de confirma\u00e7\u00e3o para {new-mail_address}. Clique no link da mensagem para atualizar o teu endere\u00e7o de e-mail.", 
    "We've sent a message to {email_address}. Click the link in the message to reset your password.": "N\u00f3s mandamos uma mensagem para {endere\u00e7o de e-mail}. Clique no link na mensagem para redefinir tua senha", 
