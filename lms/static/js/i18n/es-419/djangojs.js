...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "{paragraphStart}You entered {boldStart}{email}{boldEnd}. If this email address is associated with your {platform_name} account, we will send a message with password recovery instructions to this email address.{paragraphEnd}{paragraphStart}If you do not receive a password reset message, verify that you entered the correct email address, or check your spam folder.{paragraphEnd}{paragraphStart}If you need further assistance, {anchorStart}contact technical support{anchorEnd}.{paragraphEnd}": "{paragraphStart} Ingres\u00f3 {boldStart}{email}{boldEnd}. Si esta direcci\u00f3n de correo electr\u00f3nico est\u00e1 asociada con su cuenta {platform_name} , le enviaremos un mensaje con instrucciones para recuperar la contrase\u00f1a a esta direcci\u00f3n de correo electr\u00f3nico. {paragraphEnd}{paragraphStart}Si no recibe un mensaje de restablecimiento de contrase\u00f1a, compruebe que ha ingresado la direcci\u00f3n de correo electr\u00f3nico correcta o compruebe su carpeta de correo no deseado.{paragraphEnd}{paragraphStart}Si necesita m\u00e1s ayuda, {anchorStart}contacte soporte t\u00e9cnico{anchorEnd}.{paragraphEnd}", 
