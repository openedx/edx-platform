...
(function (globals) {
  ...
  django.catalog = {
    ...
    "%(hours)s:%(minutes)s (current UTC time)": "%(hours)s:%(minutes)s (hora UTC actual)", 
    ...
    "%(total_items)s total": "%(total_items)s total", 
    ...
    "Basic": "B\u00e1sico", 
    "Basic Account Information (required)": "Informaci\u00f3n b\u00e1sica de la cuenta (requerida)", 
    ...
    "Cannot drop more <% attrs.types %> than will assigned.": "No se pueden borrar m\u00e1s <% attrs.types %> del que ser\u00e1 asignado.", 
    "Caption": "Leyenda", 
    ...
    "Collapse All Sections": "Colapsar todas las secciones", 
    ...
    "Delete this %(xblock_type)s (and prerequisite)?": "\u00bfBorrar este %(xblock_type)s (y prerrequisitos)?", 
    ...
    "Deleting this %(xblock_type)s is permanent and cannot be undone.": "Borrar este %(xblock_type)s es una acci\u00f3n permanente y no se puede revertir.", 
    ...
    "Edit section release date": "Editar la fecha de liberaci\u00f3n de la secci\u00f3n", 
    ...
    "Failed to reset attempts.": "Fall\u00f3 al reiniciar los intentos.", 
    "File": "archivo", 
    ...
    "Please enter a term in the %(anchor_start)s search field%(anchor_end)s.": "Ingrese un t\u00e9rmino en el %(anchor_start)s campo de b\u00fasqueda%(anchor_end)s.", 
    ...
    "Showing %(current_item_range)s out of %(total_items_count)s, filtered by %(asset_type)s, sorted by %(sort_name)s ascending": "Mostrando %(current_item_range)s de %(total_items_count)s, filtrados por %(asset_type)s, ordenados por %(sort_name)s ascendentemente", 
    "Showing %(current_item_range)s out of %(total_items_count)s, filtered by %(asset_type)s, sorted by %(sort_name)s descending": "Mostrando %(current_item_range)s de %(total_items_count)s, filtrados por %(asset_type)s, ordenados por %(sort_name)s descendentemente", 
    "Showing %(current_item_range)s out of %(total_items_count)s, sorted by %(sort_name)s ascending": "Mostrando %(current_item_range)s de %(total_items_count)s,  ordenados por %(sort_name)s ascendentemente", 
    "Showing %(current_item_range)s out of %(total_items_count)s, sorted by %(sort_name)s descending": "Mostrando %(current_item_range)s de %(total_items_count)s,  ordenados por %(sort_name)s descendentemente", 
    "Showing %(first_index)s out of %(num_items)s total": "Mostrando %(first_index)s de un total de %(num_items)s ", 
    "Showing %(first_index)s-%(last_index)s out of %(num_items)s total": "Mostrando %(first_index)s-%(last_index)s de un total de %(num_items)s", 
    ...
    "Showing results for \"%(searchString)s\"": "Mostrando resultados para \"%(searchString)s\"", 
    ...
    "Speed": "Velocidad", 
    "Speed: Press UP to enter the speed menu then use the UP and DOWN arrow keys to navigate the different speeds, then press ENTER to change to the selected speed.": "Velocidad: Presione ARRIBA para acceder al men\u00fa luego use las teclas de ARRIBA y ABAJO para cambiar a diferentes velocidades, entonces presionas ENTER para cambiar a la velocidad seleccionada.", 
    ...
    "State": "Estado", 
    "Status": "Estado", 
    "Status: unsubmitted": "Estado: Sin enviar", 
    ...
    "Team \"%(team)s\" successfully deleted.": "El equipo \"%(team)s\" fue borrado exitosamente.", 
    ...
    "The team \"%(team)s\" could not be found.": "El equipo \"%(team)s no pudo ser encontrado.", 
    ...
    "Volume": "Volumen", 
    "Volume: Click on this button to mute or unmute this video or press UP or ": "Clic en este bot\u00f3n para silenciar o anular silenciar para este video o presiona ARRIBA o", 
    ...
    "We've sent a message to {email_address}. Click the link in the message to reset your password.": "Hemos enviado un mensaje a {email_address}. Haga clic en el mensaje para restablecer su contrase\u00f1a.", 
    ...
    "You are about to send an email titled '<%= subject %>' to ALL (everyone who is enrolled in this course as student, staff, or instructor). Is this OK?": "Est\u00e1 a punto de enviarse un correo electr\u00f3nico con asunto '<%= subject %>'  a todos los usuarios asociados al curso (estudiantes, instructores y funcionarios). \u00bfEst\u00e1 seguro de proceder?", 
    ...
    "Your email was successfully queued for sending.": "Su correo electr\u00f3nico fue programado para env\u00edo.", 
    ...
    "{month}/{day}/{year} at {hour}:{minute} UTC": "{day}/{month}/{year} a las {hour}:{minute} UTC", 
