...
(function (globals) {
  ...
  django.catalog = {
    ...
    "Add a clear and descriptive title to encourage participation. (Required)": "Agregue un t\u00edtulo claro y descriptivo para fomentar la participaci\u00f3n. (Necesario)", 
    ...
    "Add your post to a relevant topic to help others find it. (Required)": "Agrega tu publicaci\u00f3n a un tema relevante para ayudar a otros a encontrarla. (Necesario)", 
    ...
    "Your question or idea (required)": "Tu pregunta o idea (requerida)", 
    ...
    "discussion": "discusi\u00f3n", 
    "discussion posted %(time_ago)s by %(author)s": "discusi\u00f3n publicada %(time_ago)s by %(author)s", 
