...
'use strict';
{
  ...
  const newcatalog = {
    ...
    " to learn": "aprender",
    "${listPrice}": "${listPrice}",
    "${price}/month {currency}": "${price}/mes {currency}",
    ...
    "Explore new programs": "Explora nuevos programas",
    "Explore subscription options": "Explora las opciones de suscripci\u00f3n",
    ...
    "If you had a subscription previously, your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Si ten\u00eda una suscripci\u00f3n anteriormente, su historial de pago todav\u00eda est\u00e1 disponible en la p\u00e1gina {a_start}Pedidos y suscripciones{a_end}",
    ...
    "Manage my subscription": "Administrar mi suscripci\u00f3n",
    "Manual": "Manual",
    "March": "Marzo",
    ...
    "Monthly program subscriptions {emDash} more flexible, more affordable": "Suscripciones mensuales al programa {emDash} m\u00e1s flexibles, m\u00e1s asequibles",
    "More": "M\u00e1s",
    ...
    "Pause": "Pausar",
    "Pay {subscriptionPrice} after {trialLength}-day free trial": "Pague {subscriptionPrice} despu\u00e9s de una prueba gratuita de {trialLength} d\u00edas",
    ...
    "Restart your subscription for {subscriptionPrice}. Your payment history is still available on the {a_start}Orders and subscriptions{a_end} page": "Reinicie su suscripci\u00f3n por {subscriptionPrice}. Su historial de pagos a\u00fan est\u00e1 disponible en la p\u00e1gina {a_start}Pedidos y suscripciones{a_end}",
    ...
    "Select current industry": "Seleccione la industria actual",
    "Select fidelity": "Seleccionar fidelidad",
    "Select guardian education": "Seleccionar educaci\u00f3n de tutores",
    "Select language": "Seleccionar lenguaje",
    "Select level of education": "Seleccione el nivel de educaci\u00f3n",
    "Select military status": "Selecciona estatus militar",
    "Select one or more groups:": "Selecciones uno o mas grupos:",
    "Select prospective industry": "Seleccione la industria potencial",
    ...
    "Start {trialLength}-day free trial": "Inicie la prueba gratuita de {trialLength} d\u00edas",
    "Started": "Inici\u00f3",
    ...
    "Subscription trial expires in {remainingDays} day": [
      "La prueba de suscripci\u00f3n vence en {remainingDays} d\u00eda",
      "La prueba de suscripci\u00f3n vence en {remainingDays} d\u00edas"
    ],
    ...
    "Upgrade with a subscription": "Actualizar con una suscripci\u00f3n",
    "Upload": "Subir",
    ...
    "You have an active subscription to the {programName} program but are not enrolled in any courses. Enroll in a remaining course and enjoy verified access.": "Tiene una suscripci\u00f3n activa al programa {programName} pero no est\u00e1 inscrito en ning\u00fan curso. Inscr\u00edbete en un curso restante y disfruta de un acceso verificado.",
    ...
    "Your next billing date is {currentPeriodEnd}": "Su pr\u00f3xima fecha de facturaci\u00f3n es {currentPeriodEnd}",
    ...
    "Your {programName} trial will expire in {remainingDays} day at {trialEndTime} on {trialEndDate} and the card on file will be charged {subscriptionPrice}.": [
      "Su prueba de {programName} caducar\u00e1 en {remainingDays} d\u00eda a las {trialEndTime} el {trialEndDate} y la tarjeta registrada se cargar\u00e1 {subscriptionPrice}.",
      "Su prueba de {programName} caducar\u00e1 en {remainingDays} d\u00edas a las {trialEndTime} el {trialEndDate} y se cargar\u00e1 a la tarjeta registrada {subscriptionPrice}."
    ],
