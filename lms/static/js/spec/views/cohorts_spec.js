define(['backbone', 'jquery', 'js/common_helpers/ajax_helpers', 'js/views/cohorts', 'js/collections/cohort'],
    function (Backbone, $, AjaxHelpers, CohortsView, CohortCollection) {
