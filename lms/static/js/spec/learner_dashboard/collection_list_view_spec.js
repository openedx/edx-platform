        ...
        describe('Collection List View', function () {
            ...
            it('should load the collection items based on passed in collection', function() {
                ...
                $cards.each(function(index, el){
                    ...
                    expect($(el).find('.category span').html().trim()).toEqual(context.programsData[index].category);
                    expect($(el).find('.organization span').html().trim()).toEqual(context.programsData[index].organizations[0].display_name);
                    expect($(el).find('.card-link').attr('href')).toEqual(context.programsData[index].marketing_url);
                });
            });
