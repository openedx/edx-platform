...
latex_documents = [
  ('index', 'nbgrader.tex', 'nbgrader Documentation',
...
man_pages = [
    ('index', 'nbgrader', 'nbgrader Documentation',
...
texinfo_documents = [
  ('index', 'nbgrader', 'nbgrader Documentation',
   'Jupyter Development Team', 'nbgrader', 'One line description of project.',
   'Miscellaneous'),
]
